                        ...
                        <div class="TopArea" style="padding-top: 11px;z-index: 0;padding-bottom: 9px;">
                            <div class="container-fluid row px-0">
                                <div class="float-left search-col row d-flex flex-nowrap align-items-center"
                                    ...
                                    <div class="text-center mr-3 px-2 sortable" data-column="j.account_no" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 10%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: underline;color: #595959 !important; font-family: Signika !important;">Account</a>
                                    </div>
                                    <div class="mr-3 px-2 sortable" data-column="g.description" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 33%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Description</a>
                                    </div>
                                    <div class="text-center mr-3 px-2 sortable" data-column="column-a-debit" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 15%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Debit</a>
                                    </div>
                                    <div class="text-center mr-3 px-2 sortable" data-column="column-a-credit"
                                        data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 15%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Credit</a>
                                    </div>
                                    <div class="text-center mr-3 px-2 sortable" data-column="columnba-debit" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 15%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Debit</a>
                                    </div>
                                    <div class="text-center mr-3 px-2 sortable" data-column="column-b-credit"
                                        data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 15%; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Credit</a>
            ...
            <div class="modal fade" id="ExportModalNew" tabindex="-1" role="dialog" data-backdrop="static"
                ...
                <div class="modal-dialog modal-dialog-centered  -lg modal-bac " role="document">
                    <div class="modal-content">
                        <div class="block  block-transparent mb-0">
                            <div class="block-header pb-0  ">
                                <span class="b e section-header">Export</span>
                                <div class="block-options">
                                    {{-- <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                        <i class="fa fa-fw fa-times"></i>
                                    </button> --}}
                            ...
                            <div class="block-content new-block-content pt-0 pb-0 ">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p>Would you like to export Trial Balance?</p>
                                    </div>
                                </div>
                            </div>
                            <div class="block-content block-content-full pt-4 px-5"
    ...
    <script type="text/javascript">
        ...
        `;
            ...
            $(document).on('click', '.btn-export-confirm', function() {
                ...
                var url = '{{ url('journal-trail-balance-export') }}';
                if (client_id && client_fyear) {
                    var $btn = $(this);
            ...
            function getContent() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('/journal/load-content-traial-balance') }}",
                    data: {
                        "client_id": client_id,
                        "client_fyear": client_fyear,
                        "fiscal_year": fiscal_year,
