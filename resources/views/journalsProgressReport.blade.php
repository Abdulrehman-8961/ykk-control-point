...
@section('content')
    ...
    <main id="main-container pt-0" style="overflow: hidden">
        ...
        <style type="text/css">
            ...
            #btn-prev-year:hover img,
            #btn-next-year:hover img {
            ...
            #btn-prev-source:hover img,
            #btn-next-source:hover img {
                filter: drop-shadow(0px 0px 3pt rgba(127, 127, 127, 0.6));
            }
                            ...
                            <div class="container-fluid row px-0">
                                <div class="float-left search-col row d-flex flex-nowrap" style="width: 70%;">
                                    <div class="col-sm-3 d-flex align-items-center justify-content-end"
                                        ...
                                        <div class="mr-3">Fiscal Year</div>
                                        <div class="source-container position-relative">
                                            <span id="year-text">&nbsp;</span>
                                            <a id="btn-prev-year" class="position-absolute btn">
                                                <img src="{{ asset('public') }}/icons/left_arrow_clean.png" width="25"
                                                    alt="">
                                            </a>
                                            <a id="btn-next-year" class="position-absolute btn">
                                    ...
                                    <input type="hidden" name="journel_year" id="journel_year">
                        ...
                        <div class="TopArea" style="padding-top: 11px;z-index: 0;padding-bottom: 9px;">
                            <div class="container-fluid row px-0">
                                <div class="float-left search-col row d-flex flex-nowrap align-items-center"
                                    style="width: 100%; padding-left: 40px !important;">
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_1" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: underline;color: #595959 !important; font-family: Signika !important;">Period</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_2" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 115px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Month</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_3" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">CD</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_4" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">COD</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_5" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">SJ</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_6" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">PS</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_7" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">GJ</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="column_8" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 80px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">ADJ</a>
                                    </div>
                                    <div class="extraSources d-flex"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        <div class="block  block-transparent mb-0">
                            ...
                            <div class="block-content new-block-content pt-0 pb-0 ">
                                ...
                                <div class="row justify-content- form-group  push d-none">
                                    <div class="col-sm-3">
                    ...
                    <div class="modal-content">
                        <div class="block  block-transparent mb-0">
                            ...
                            <div class="block-content new-block-content pt-0 pb-0 ">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p>Would you like to export ALL periods for the current source?</p>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        `;
            ...
            //     let column = $(this).data('column'); // example: column_1
            //     let order = $(this).data('order'); // asc or desc
            //     console.log(column, order);


            //     let rows = $('.data-container .data-row'); // class for each data row (you must add this in your blade loop)

            //     rows.sort(function(a, b) {
            //         let valA = $(a).data(column).toString().toLowerCase();
            //         let valB = $(b).data(column).toString().toLowerCase();
            ...
            $(document).on('click', '.sortable', function() {
                ...
                let rows = $('.data-container .data-row');
                rows.sort(function(a, b) {
                    let valA = $(a).find('[data-' + column + ']').data(column);
                    let valB = $(b).find('[data-' + column + ']').data(column);

                    // Normalize
                    valA = valA !== undefined && valA !== null ? valA.toString().toLowerCase() : '';
                    valB = valB !== undefined && valB !== null ? valB.toString().toLowerCase() : '';

                    // Special case for month sorting
                    if (column === 'column_2') {
                        let numA = monthOrder[valA] || 0;
                        let numB = monthOrder[valB] || 0;
                    ...
                    if (response.length > 0) {
                        response.forEach((ele, index) => {
                            $("#JournalFYReIndexModal select[name=change_fiscal_year]")
                                .append(`<option value="${ele}" ${index === 0 ? 'selected' : ''}>${ele}</option>`);
                        });
                    }
                    $("#JournalFYReIndexModal select[name=change_client]").select2();
                });
            ...
            $('.btn-select-client').on('click', function() {
                ...
                var change_fiscal_year = $('#change_fiscal_year option:selected').val();
                if (change_client == '' || change_client == null || change_client == undefined) {
                    ...
                    Dashmix.helpers('notify', {
                        ...
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Fiscal year not found.',
                        delay: 5000
                    });
                    return false;
                }
                ...
                // $("#year-text").text(change_fiscal_year);
                // $("#journel_year").val(change_fiscal_year);
            ...
            $(document).on('click', '.btn-export-confirm-current', function() {
                ...
                var url = '{{ url('journal-by-period-export') }}';
                if (client_id && client_fyear && period && source_text) {
                    var $btn = $(this);
            ...
            $(document).on('click', '.btn-export-confirm', function() {
                ...
                var source_text = $('#source_text').val();
                var url = '{{ url('journal-by-period-export') }}';
                if (client_id && client_fyear && source_text) {
                    var $btn = $(this);
                    var originalContent = $btn.html();
                    if ($btn.hasClass('disabled')) {
                        return;
            ...
            function getContent() {
                var client_id = $('#client_id').val();
                var client_fyear = $('#client_fyear').val();
                var fiscal_year = $('#journel_year').val();
                $.ajax({
                    type: "GET",
                    url: "{{ url('/journal/load-content-progress-report') }}",
                    data: {
                        "client_id": client_id,
                        "client_fyear": client_fyear,
            ...
            function getextraSources() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('/journal/load-extra-sources') }}",
                    data: {
                        "client_id": client_id,
                        "client_fyear": client_fyear,
                        "fiscal_year": fiscal_year,
            ...
            function loadYears() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        let yearsData = response.years;
                        let currentIndex = yearsData.length > 0 ? 0 : -1;

                        function updateAccount(index) {
                            if (index >= 0 && index < yearsData.length) {
                                $("#year-text").text(yearsData[index].fyear);
                                $("#journel_year").val(yearsData[index].fyear);
                                currentIndex = index;
                            }
                            getContent();
                            getextraSources();
                        ...
                        $("#btn-prev-year").off('click').on('click', function() {
                            if (yearsData.length === 0) return;
                            let prevIndex = (currentIndex - 1 + yearsData.length) % yearsData
                                .length;
                        ...
                        // Next Button Click
                        $("#btn-next-year").off('click').on('click', function() {
                            if (yearsData.length === 0) return;
                            let nextIndex = (currentIndex + 1) % yearsData.length;
