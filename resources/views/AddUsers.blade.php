...
<main id="main-container  " style="padding:3mm">
    ...
    <div class="block card-round   bg-new-blue new-nav">
        <div class="block-header   py-new-header py-new-header2"
            style="padding-top: 5px !imortant; padding-bottom: 5px !important;">
            <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="" style="margin-left: .91rem;">
                        <h4 class="mb-0 header-new-text" style="line-height:20px">New User
                        </h4>
                ...
                <div class="new-header-icon-div">
                    ...
                    <a href="javascript:;" class="saveContract text-white" data-toggle="tooltip" data-trigger="hover"
                        data-placement="top" title="" data-original-title="Add and Continue" class="text-white"><i
                            class="fa fa-plus texti-white"></i> </a>
        ...
        <form id="form-1" action="{{url('insert-client')}}" class="js-validation   " method="POST"
            ...
            <div class="block new-block   ">
                ...
                <div class="block-content new-block-content">
                        ...
                        <div class="col-sm-6">
                            <div class="custom-control custom-switch custom-control-warning custom-control-lg mt-2 ">
                                <input type="checkbox" class="custom-control-input" id="portal_access"
                                    name="portal_access" value="1" checked="">
                    ...
                    <div class="row form-group ">
                        ...
                        <div class="col-sm-6">
                            <select type="text" class="form-control" id="access_type" name="access_type">
                                ...
                                <option value="read" {{old('access_type')=='read' ?'selected':''}}>Read</option>
                                 <option value="write" {{old('access_type')=='write' ?'selected':''}}>Write</option>
                    ...
                    <div class="row form-group divHide ClientDiv d-none">
            ...
            <div class="block  block-transparent mb-0">
                ...
                <div class="block-content new-block-content pt-0 pb-0 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10   form-group      ">
                            <select type="" class="form-control selectpicker" data-live-search="true" id="hostname"
                                value="" name="cert_hostname">
 ...
 imagePreviewMarkupFilter:false,
   ...
   content3_image=content3_image.filter(function(ele){
           ...
           @if(Session::has('success'))
             ...
             Dashmix.helpers('notify', {from: 'bottom',align: 'left',type: 'success', icon: 'fa fa-check mr-1', message: '{{Session::get('success')}}'});
...
if(data1==0){
        ...
        Dashmix.helpers('notify', {from: 'bottom',align: 'left',message: 'User Succesfully added', delay: 5000});


     window.location.href=unEntity('{{URL::previous()==URL::full()?url('users'):URL::previous()}}');
}else{
      Dashmix.helpers('notify', {from: 'bottom',align: 'left',message: 'User Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding User</span>', delay: 5000});
}
