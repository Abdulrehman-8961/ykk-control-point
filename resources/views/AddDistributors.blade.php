                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">New Distributor
</h4>
                        ...
                        <input type="hidden" name="attachment_array" id="attachment_array" >
                                <div class="row">
                                  ...
                                  <div class="form-group row">
                                        ...
                                        <input type="name" class="form-control" id="distributor_name" name="distributor_name"   >
                                            </div>
...
var data1=$(this).attr('data');
 ...
 if(distributor_name==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for distributor.', delay: 5000});
