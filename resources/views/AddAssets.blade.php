                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text " style="line-height:27px">New <span class="text-capitalize">{{$type}}</span> Asset</h4>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <select type="" class="form-control select2" id="asset_type_id"  value="" name="asset_type_id"   >
                                                    ...
                                                    <option value="{{$c->asset_type_id}}" data="{{$c->asset_type_description}}"
                                                    {{$type=='virtual'?($c->asset_type_description=='Virtual Machine'?'selected':''):($c->asset_type_description=='Physical Server'?'selected':'')}} >

                                                    {{$c->asset_type_description}}</option>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                 <select type="client_id" class="form-control select2" id="client_id"  value="" name="client_id" placeholder="Client"  >
                                                    ...
                                                    @foreach($client as $c)
                                                    <option value="{{$c->id}}" data-logo="{{$c->logo}}"  data-email="{{$c->email_address}}" data-renewal_notification_email="{{$c->renewal_notification_email}}" data-address="{{nl2br($c->client_address)}}">{{$c->firstname}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
 ...
 <?php
                                            ...
                                            <div class="col-sm-10">
                                                <select type="" class="form-control select2" id="os"  value="" name="os"   >
                                                    ...
                                                    <option value="{{$c->id}}" {{old('os')==$c->id?'selected':''}}>{{$c->operating_system_name}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                        </div>
                                      ...
                                      <div class="row form-group storageHide1">
                                         ...
                                         <div class="form-group row storageHide">
                                            ...
                                            <div class="col-sm-4">
                                             <select type="text" class="form-control select2" id="domain" name="domain" placeholder=""  >
                                                        <option value=""></option>
                                                         <?php
                                                    if(old('client_id')!=''){
                                                        $domain=DB::table('domains')->where('client_id',old('client_id'))->orderBy('domain_name','asc')->get();

                                                     ?>
                                                    @foreach($domain as $s)
                                                        <option value="{{$s->id}}" {{old('domain')==$s->id?'selected':''}}>{{$s->domain_name}}</option>
                                                    @endforeach
                                                <?php } ?>
                                                </select>
                                            </div>
                                           ...
                                           <div class="row form-group storageHide">
                                            ...
                                            <div class="col-sm-10">
                                               <input type="text" class="form-control" list="useDatalist"  value="{{old('use_')}}" id="use_" name="use_"   >
                                                 <?php $use=DB::Table('assets')->select(DB::raw('distinct(use_) as use_'))->get();

                                                     ?> <datalist id="useDatalist">

                                                    @foreach($use as $u)
                                                        <option value="{{$u->use_}}"></option>
                                                    @endforeach
...
<div class="contract_type_button  w-100 mr-4"  >
      <input type="checkbox" class="custom-control-input" id="HasWarranty1" name="HasWarranty" value="1"   checked  >
  <label class="btn btn-new w-75 supported " for="HasWarranty" data-toggle="tooltip" data-trigger="hover" data-html="true"  title="Allows you to assign
contracts to asset"  > Supported</label>
</div>
</div>
</div>
   ...
   <div class="block new-block storageHide" >
...
<div class="contract_type_button  w-100 mr-4 mb-3">
  <input type="checkbox" class="custom-control-input" id="ntp" name="ntp" value="1"    >
...
<div class="contract_type_button  w-100 mr-4 mb-3"  >
      <input type="checkbox" class="custom-control-input" id="HasWarranty" name="HasWarranty" value="1"   checked  >
  <label class="btn btn-new w-75 supported " for="HasWarranty" data-toggle="tooltip" data-trigger="hover" data-html="true"  title="Allows you to assign
contracts to asset"  > Supported</label>
</div>
</div>
...
<div class="contract_type_button  w-100 mr-4  "     >
          <input type="checkbox" class="custom-control-input" id="clustered" name="clustered" value="1"   >
...
<div class="contract_type_button  w-100 mr-4  "     >
     <input type="checkbox" class="custom-control-input" id="internet_facing" name="internet_facing" value="1"   >
...
<div class="contract_type_button  w-100 mr-4 "     >
              <input type="checkbox" class="custom-control-input" id="load_balancing" name="load_balancing" value="1"   >
...
<div class="contract_type_button ">
  <input type="radio" id="NotSupportedReason1" name="NotSupportedReason" checked   value="N/A"/>
  <label class="btn btn-new " for="NotSupportedReason1" >N/A</label>
</div>
<div class="contract_type_button">
  <input type="radio" id="NotSupportedReason2" name="NotSupportedReason" value="End Of Life"/>
  <label class="btn btn-new ml-2" for="NotSupportedReason2"   >End Of Life</label>
</div>

           <div class="contract_type_button">
  <input type="radio" id="NotSupportedReason3" name="NotSupportedReason"  value="Other Partner"/>
  <label class="btn btn-new ml-2" for="NotSupportedReason3"   >Other Partner</label>
</div>

    <div class="contract_type_button">
  <input type="radio" id="NotSupportedReason4" name="NotSupportedReason"  value="Forgone"/>
    ...
    <?php
                                            ...
                                            <div class="col-sm-4">
                                               <select type="" class="form-control select2" id="manufacturer"  value="" name="manufacturer"  >
                                                    ...
                                                    <option value="{{$c->id}}"   {{old('manufacturer')==$c->id?'selected':''}} >{{$c->vendor_name}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-sm-2 mandatory col-form-label" for="example-hf-email">Model</label>
                                            <div class="col-sm-4">
                                                         <input type="text" class="form-control" list="modelDatalist"   value="{{old('model')}}" id="model" name="model"   >
                                            ...
                                            <div class="col-sm-4">
                                                      <input type="text" class="form-control" list="typeDatalist"  value="{{old('type')}}" id="type" name="type"   >
                      ...
                      <div class="col-sm-4">
                <input type="text" class="form-control valid"  id="sn" name="sn"   aria-invalid="false">
                                            </div>
                                        </div>

                                            <div class="row form-group cpuDiv">
                                                         <label class="col-sm-2    col-form-label" for="example-hf-email">CPU Model

 </label>

                                            <div class="col-sm-4">
                                              <input type="text" class="form-control" list="cpuDatalist"  id="cpu_model" name="cpu_model"   >
                                           ...
                                           <label class="col-sm-2    col-form-label" for="example-hf-email">No. of Sockets </label>
                                              <div class="col-sm-2">
                                                <input type="number" class="form-control"   id="cpu_sockets" name="cpu_sockets"   >
                                            </div>
                                            ...
                                            <input type="number" class="form-control"   id="cpu_cores" name="cpu_cores"    >
                                              ...
                                              <div class="col-sm-2">
                                              <input type="number" class="form-control"   id="cpu_freq" name="cpu_freq"   >
                                            </div>
                                        </div>
                                           <div class="row form-group storageHide">
...
<div class="row form-group  ">
                                           <label class="col-sm-2  mandatory  col-form-label" for="example-hf-email">vCPUs</label>
                                              <div class="col-sm-2">
                                           <input type="number" class="form-control" id="vcpu" name="vcpu"   >
                                            </div>
...
<div class="block new-block storageHide" >
             ...
             $vlan=DB::Table('network')->select('network.*','nz.network_zone_description','nz.tag_back_color','nz.tag_text_color')->where('network.is_deleted',0) ->where('network.client_id',old('client_id'))->where('network.site_id',old('site_id'))
->leftjoin('network_zone as nz','nz.network_zone_description','=','network.zone')->orderBy('vlan_id','asc')->get();


                                                     ?>
                                                    @foreach($vlan as $s)
                                                        <option value="{{$s->id}}" data-subnet_ip="{{$s->subnet_ip}}" data-mask="{{$s->mask}}"  data-description="{{$s->description}}" data-gateway_ip="{{$s->gateway_ip}}" data-ssid_name="{{$s->ssid_name}}" data-bg="{{$s->tag_back_color}}" data-color="{{$s->tag_text_color}}" data-zone="{{$s->zone}}"  {{old('vlan_id')==$s->id?'selected':''}}>{{$s->vlan_id
                                                        }}</option>
                                                    @endforeach
                                                <?php } ?>
                              </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="ip_address" name="ip_address" placeholder="CIDR FORMAT" value="{{old('ip_address')}}"  >
                                            </div>
...
<div class="contract_type_button  w-100 mr-4  ">
      <input type="checkbox" class="custom-control-input" id="managed" name="managed" value="1"    >
  <label class="btn btn-new w-75 managed" for="managed">Unmanaged</label>
</div>
</div>
...
<div class="ManagedBlock d-none">
<div class="form-group row">
                                            <label class="col-sm-2   col-form-label" for="example-hf-email">App Owner
</label>
                                            <div class="col-sm-4">
                                                      <input type="text" class="form-control"  list="app_ownerDatalist"  id="app_owner" name="app_owner" placeholder="Enter App Owner"  >
                                            ...
                                            <div class="col-sm-4">
                                               <input type="text" class="form-control" list="slaDatalist"  id="sla" name="sla" placeholder=""  >
...
<div class="contract_type_button  w-100 mr-4  px-4"     data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System is patched automatically or manually" >
          <input type="checkbox" class="custom-control-input" id="patched" name="patched" value="1"   >
...
<div class="contract_type_button  w-100 mr-4  px-4"       data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System is monitored">
       <input type="checkbox" class="custom-control-input" id="monitored" name="monitored" value="1"   >
...
<div class="contract_type_button  w-100 mr-4 px-4 "      data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System data is protected">
        <input type="checkbox" class="custom-control-input" id="backup" name="backup" value="1"   >
...
<div class="contract_type_button  w-100 mr-4 px-4 "      data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System has Anti-Virus installed" >
           <input type="checkbox" class="custom-control-input" id="antivirus" name="antivirus" value="1"   >
...
<div class="contract_type_button  w-100 mr-4  px-4"     data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System is replicated"  >
          <input type="checkbox" class="custom-control-input" id="replicated" name="replicated" value="1"   >
...
<div class="contract_type_button  w-100 mr-4 px-4 "    data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System is scanned by Drawbridge"   >
          <input type="checkbox" class="custom-control-input" id="disaster_recovery" name="disaster_recovery" value="1"   >
...
<div class="contract_type_button  w-100 mr-4  px-4"    data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System sends info to SIEM/Syslog"    >
                     <input type="checkbox" class="custom-control-input" id="syslog" name="syslog" value="1"   >
...
<div class="contract_type_button  w-100    px-4 "      data-toggle="tooltip" data-trigger="hover"  data-placement="top" title="" data-original-title="System requires SMTP Relay Access"  >
      <input type="checkbox" class="custom-control-input" id="smtp" name="smtp" value="1"   >
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right" style="width: 100px;">
                                                       <!-- -->
                                                       <div  >
                                                       <div  class="text-center font-size-md bubble-white-new border-none bubble-text-sec px-2    " style="background:${bg};color:${color};width:fit-content!important;border-radius:5px;min-height:32px!important;border:none;">
...
$.ajax({
  ...
  $('#hostname').focus();
        ...
        click=0;
if(data1==0){
            Dashmix.helpers('notify', {align: 'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1">  Asset Succesfully added', delay: 5000});
    window.location.href=unEntity('{{URL::previous()==URL::current()?url($type):URL::previous()}}');
}
else{

     Dashmix.helpers('notify', {align: 'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1">  Asset Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding assets</span>', delay: 5000});
