                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-dark new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text " style="line-height:27px">New Site</h4>
                                <p class="mb-0  header-new-subtext" style="line-height:17px"><?php echo date('Y-M-d') ?> by {{Auth::user()->firstname.' '.Auth::user()->lastname}}</p>
                                    ...
                                    <div class="new-header-icon-div">
                                           ...
                                           <a href="javascript:;"  class="saveContract text-white" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Add and Continue"  class="text-white"><i class="fa fa-plus texti-white"  ></i> </a>
                                              ...
                                              <a href="javascript:;" class="text-white saveContract"  data="0"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save Site"><i class="fa fa-check text-white"   ></i> </a>

                                            <a  data-toggle="tooltip" data-trigger="hover" data-placement="top" title=""   id="btnClose" data-original-title="Close" href="javascript:;" class="text-white btnClose"><i class="fa fa-times texti-white"   ></i> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  <div class="block-header py-0" style="padding-left:7mm;">
                           ...
                           <div class="row">
                                  ...
                                  <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                               <input type="text" class="form-control valid" id="site_name" name="site_name" placeholder="Site Name" aria-invalid="false">
                                            </div>
    ...
    <div class="block new-block  " >
                            ...
                            <div class="block-header py-0" style="padding-left:7mm;">
                                 ...
                                 <a class="  section-header"  >Address Information
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group storageHide">
                                                         <label class="col-sm-2  mandatory col-form-label" for="example-hf-email">Country
 </label>
 <?php
                                            $network_zone=DB::Table('network_zone')->where('is_deleted',0)->orderBy('network_zone_description','asc')->get();
                                             ?>
                                            <div class="col-sm-4">
                                                    <select type="text" class="form-control   select2" id="country" name="country" placeholder="Country"  >
                                                    <option value=""></option>
                                                           <?php
                                      ...
                                      <div class="form-group row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">Address</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="  row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">City </label>
                                        
                                               <div class="col-sm-4 form-group">
                                                 <input type="text" class="form-control" list="cityDatalist" value=""  id="city" name="city" placeholder="City"  >
                                                  <datalist id="cityDatalist">
                                                    <?php $use=DB::Table('sites')->select(DB::raw('distinct(city) as city'))->get(); 
                                               ...
                                               <div class="  row">
                                                   ...
                                                   <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">State/Province</label> 
                                              
                                            
                                            <div class="col-sm-4 form-group">
                                                   <input type="text" class="form-control"  list="modelDatalist" id="province"  value=""  name="province" placeholder="Province"  >
                                                    <?php $use=DB::Table('sites')->select(DB::raw('distinct(province) as province'))->get(); 
                                      ...
                                      <div class="form-group row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">Zip/Postal Code</label>
                                            <div class="col-sm-4">
                                                       <input type="text" class="form-control" id="zip" name="zip"  value=""placeholder="Zip"  >
                                            </div>
                                         ...
                                         <div class="f  row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">Phone</label>
                                            <div class="col-sm-2 form-group">
                                                 <input type="" class="form-control" id="phone" name="phone" placeholder="Phone" value="" >
                                            </div>
                                            <div class="col-sm-2 form-group">
                                                 <input type="" class="form-control" id="fax" name="fax" placeholder="Fax"  value="">
                                            </div>
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Site.', delay: 5000});
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for Address.', delay: 5000});
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Province.', delay: 5000});
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Phone.', delay: 5000});

    }
      else  if(fax==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Fax.', delay: 5000});
...
if(data1==0){
            Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Site Succesfully added', delay: 5000});
    window.location.href=unEntity('{{URL::previous()==URL::current()?url('network'):URL::previous()}}');
}
else{
   
     Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Site Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding assets</span>', delay: 5000});
