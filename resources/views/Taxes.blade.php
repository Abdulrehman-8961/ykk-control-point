...
@section('content')
    ...
    if (isset($_GET['limit']) && $_GET['limit'] != '') {
        ...
        if ($no_check != '') {
            ...
            DB::table('settings')->insert(['user_id' => Auth::id(), 'taxes' => $limit]);
        }
    } else {
        if ($no_check != '') {
            if ($no_check->taxes != '') {
                $limit = $no_check->taxes;
            }
        }
    }
    ...
    if (sizeof($_GET) > 0) {
        ...
        $qry = DB::table('tax_rate')
            ->where('is_deleted', 0)
            ->where(function ($query) {
                $query->Orwhere('province', 'like', '%' . @$_GET['search'] . '%');
                $query->Orwhere('tax_label_1', 'like', '%' . @$_GET['search'] . '%');
                $query->Orwhere('tax_label_2', 'like', '%' . @$_GET['search'] . '%');
                $query->Orwhere('tax_rate_1', 'like', '%' . @$_GET['search'] . '%');
                $query->Orwhere('tax_rate_2', 'like', '%' . @$_GET['search'] . '%');
                $query->Orwhere('tax_rate_status', 'like', '%' . @$_GET['search'] . '%');
            })
            ->orderBy($field, $orderby)
            ->paginate($limit);
    } else {
        $qry = DB::table('tax_rate')->where('is_deleted', 0)->orderBy('id', 'desc')->paginate($limit);
    }
    if (isset($_GET['id'])) {
        $GETID = $_GET['id'];
    } else {
    ...
    padding-bottom: 11px;">
                        <div class="row">
                            ...
                            <div class="col-sm-9 search-col row">
                                <div class="push mb-0 col-sm-4 pr-0">
                                    ...
                                    $filter = (isset($_GET['advance_search']) ? 'advance_search=' . $_GET['advance_search'] : '') . (isset($_GET['province']) ? '&province=' . $_GET['province'] : '') . (isset($_GET['tax_rate_status']) ? '&tax_rate_status=' . $_GET['tax_rate_status'] : '') . (isset($_GET['slider']) ? '&slider=' . $_GET['slider'] : '') . (isset($_GET['limit']) ? '&limit=' . $_GET['limit'] : '');
                                    ?>

                                    <form class="push mb-0" method="get" id="form-search"
                                        action="{{ url('taxes/') }}?{{ $filter }}">

                                        <div class="input-group main-search-input-group" style="max-width: 74.375%;">
                                            <input type="text" value="{{ @$_GET['search'] }}"
                                                class="form-control searchNew" name="search" placeholder="Search Tax Rate">
                                    ...
                                    <span data-toggle="modal" data-bs-target="#filterModal" data-target="#filterModal">
                                        ...
                                        @if (Auth::user()->role != 'read')
                                            ...
                                            <a class="btn btn-dual AddTaxModal d2 " data-custom-class="header-tooltip"
                                                ...
                                                title="" data-original-title="Add Tax Rate" href="javascript:;">
                            ...
                            <div class="d-flex text-right col-lg-3 justify-content-end">
                                ...
                                <form id="limit_form" class="ml-2 mb-0"
                                    action="{{ url('taxes') }}?{{ $_SERVER['QUERY_STRING'] }}">
            ...
            <div class="content  ">
                    ...
                    <div class="col-lg-4    no-print" style="overflow-y: auto;height: 90vh; margin-top: 1px;">
                        <div style="overflow-y: auto;height: 90vh;">
                            @foreach ($qry as $q)
                                <div class="block block-rounded   table-block-new mb-2 pb-0  -  viewContent mr-2"
                                    ...
                                    <div class="block-content pt-1 pb-1 d-flex  pl-1 position-relative" style="">
                                        <div class="mr-1 justify-content-center align-items-center d-flex"
                                            ...
                                            @if ($q->province == 'British Columbia')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/bc.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Saskatchewan')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/saskatchewan.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Alberta')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/alberta.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Manitoba')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/manitoba.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'New Brunswick')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/brunswick.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Nova Scotia')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/nova_scotia.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Ontario')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/ontario.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Newfoundland and Labrador')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/newfoundland.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Prince Edward Island')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/pei.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @elseif($q->province == 'Quebec')
                                                <img src="{{ asset('/public') }}/tax_icons/modified/quebec.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @else
                                                <img src="{{ asset('/public') }}/icons2/icon-taxes-grey.png"
                                                    class="rounded-circle"
                                                    style="width: 70px;height: 70px;object-fit: cover;">
                                            @endif
                                        ...
                                        <div class=" d-flex justify-content-between" style="width: 70%;">
                                            <div class="d-flex flex-column" style="width: calc(100% - 130px)">
                                                <span class="font-12pt mb-0 text-truncate font-w600 c1"
                                                    style="font-family: Calibri;color:#4194F6 !important;">Tax Rate</span>
                                                <span
                                ...
                                padding-bottom: 2px;
                                padding-left: 5px;
                                padding-right: 5px;">{{ $q->province }}</span>
                                                <div
                                                    style="overflow: hidden;
                                text-overflow: ellipsis;
                                width: fit-content;
                                ...
                                white-space: nowrap;
                                font-size: 11pt;
                                font-family: Calibri;padding-top: 3px;">
                                                    @if ($q->slider == 1 || $q->slider == 2)
                                                        <span><b>{{ $q->tax_label_1 }}</b> {{ $q->tax_rate_1 }}%</span>
                                                    @endif
                                                    @if ($q->slider == 2)
                                                        <span><b>{{ $q->tax_label_2 }}</b> {{ $q->tax_rate_2 }}%</span>
                                                    @endif
                                                </div>
                                            </div>
                                ...
                                font-size: 11pt;">Inactive</span>
                                            ...
                                            <div class="d-flex flex-row justify-content-end"
                                                style="margin-top: 20px;position: absolute;right: 10px;bottom: 6px;">
                                                <?php     if(Auth::check()){
                                    if(@Auth::user()->role!='read'){ ?>
                                                ...
                                                <div class="ActionIcon  ml-2    "
                                                    style="margin-left: 0.25rem !important;border-radius: 1rem">
                ...
                <img src="{{asset('/public')}}/icons2/icon-taxes-grey.png" class="rounded-circle"
            ...
            <div class="  " style="width:55%">
                ...
                <div class="d-flex " style="padding-top: 6px">
                    ...
                    <p class="font-11pt mr-1   mb-0 pk-1 pk-blue " style=" " data="{{$q->id}}"
                        data-toggle="tooltip">{{$q->province}}</p>
                ...
                <div class="d-flex pt-1">
                    @if ($q->slider == 1 || $q->slider == 2)
                    <p class="font-11pt mr-4   mb-0  pk-1 pk-purple  " style=" " data="{{$q->id}}"
                        data-toggle="tooltip">{{$q->tax_label_1}}</p>
                    <p class="font-11pt mr-4   mb-0    " style=" " data="{{$q->id}}" data-toggle="tooltip">
                        {{$q->tax_rate_1}}%</p>
                    @endif
                    @if ($q->slider == 2)
                    <p class="font-11pt mr-3   mb-0  pk-1 pk-purple  " style=" " data="{{$q->id}}"
                        data-toggle="tooltip">{{$q->tax_label_2}}</p>
                    <p class="font-11pt mr-4   mb-0    " style=" " data="{{$q->id}}" data-toggle="tooltip">
                        {{$q->tax_rate_2}}%</p>
                    @endif
            ...
            <div style="position: absolute;width:  ; top: 10px;right: 10px;">
                ...
                <div class=" text-right" style="width:10%;;">
                    ...
                    <div class=""
                        style="position: absolute;width: 100%; bottom:11px;right: 5px;display: flex;align-items: center;justify-content: end;">
                    ...
                    <form class="mb-0 pb-0" action="{{ url('end-tax') }}" method="post">
                        @csrf
                                ...
                                <div class="modal-content">
                                    <div class="block  block-transparent mb-0">
                                        <div class="block-header pb-0  ">
                                            <span class="b e section-header"><span class="revokeText">Revoke</span> Tax
                                                Rate</span>
                    ...
                    <form class="mb-0 pb-0" id="form-add-tax" action="{{ url('insert-tax') }}" method="post">
                        @csrf
                        <div class="modal fade" id="AddTaxModal" tabindex="-1" role="dialog" data-backdrop="static"
                            ...
                            <div class="modal-dialog modal-dialog-centered  modal-lg modal-bac "
                                ...
                                <div class="modal-content" style="min-height: 349px;">
                                    <div class="block  block-transparent mb-0" style="padding-top: 18px !important;">
                                        <div class="block-header pb-0  ">
                                            <span class="b e section-header">Tax Rates</span>
                                            <div class="block-options">
                                        ...
                                        <div class="block-content new-block-content pt-0 pb-0 ">
                                            ...
                                            <div class="row  form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <select type="" name="province" class="form-control select2">
                                                        ...
                                                        @if (@$system_settings->country != '')
                                                            ...
                                                            @foreach ($city_qry as $c)
                                                                <option value="{{ $c->state_name }}">{{ $c->state_name }}
                                                                </option>
                                                            @endforeach
                                                        @endif
                                                ...
                                                <div class="col-lg-2 ">
                                                    <input type="text" class="js-rangeslider pb-3" id="slider1"
                                                        name="slider" data-from="1" data-values="0,1,2">

                                                </div>
                                            </div>
                                            <div class="row form-group TaxDiv1">
                                                <div class="col-lg-3">

                                                    <input type="" name="tax_label_1"
                                                        class="form-control label-control" placeholder="Label">

                                                </div>

                                                <div class="col-lg-4 ">
                                                    <input type="" name="tax_rate_1" class="form-control"
                                                        placeholder="Tax Rate%">
                                                </div>
                                                <div class="col-auto pl-0">
                                                    <span class="badge-tag d-none" id="federal_tag">Federal</span>
                                                    <span class="badge-tag" id="harmonized_tag"
                                                        style="margin-left: 9px;">Harmonized</span>
                                                </div>
                                            </div>
                                            <div class="row form-group TaxDiv2 d-none">
                                                <div class="col-lg-3">
                                                    <input type="" name="tax_label_2"
                                                        class="form-control label-control" placeholder="Label">

                                                </div>

                                                <div class="col-lg-4">
                                                    <input type="" name="tax_rate_2" class="form-control"
                                                        placeholder="Tax Rate%">
                                                </div>
                                                <div class="col-auto pl-0">
                                                ...
                                                <div class="col-lg-2 pl-0">
                                                    <div class="custom-control  custom-control-lg mt-2 ">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="applied_to_tax1" name="applied_to_tax1" value="1">
                                                        <label class="custom-control-label applied_to_tax1_tooltip"
                                                            data="tax_label_1" for="applied_to_tax1">
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="block-content block-content-full text-right  pt-4"
                                            style="padding-left: 9mm;padding-right: 9mm;position: absolute; bottom: 0; width: 100%;">
                                            <button type="submit" class="btn mr-3 btn-new ">Save</button>
                        ...
                        <div class="modal fade" id="ExportModal" tabindex="-1" role="dialog" data-backdrop="static"
                            ...
                            <div class="modal-dialog modal- -centered  modal-md modal-bac " role="document">
                                <div class="modal-content">
                                    <div class="block  block-transparent mb-0">
                                        <div class="block-header pb-0  ">
                                            <span class="b e section-header">Export Tax Rate</span>
                                            <div class="block-options">
        ...
        $(function() {
            ...
            $('#slider1').change(function() {
                if ($(this).val() == 1) {
                    ...
                    $('#harmonized_tag').removeClass('d-none');
                    $('#federal_tag').addClass('d-none');
                    ...
                    $('#harmonized_tag').addClass('d-none');
                    $('#federal_tag').removeClass('d-none');
                } else {
            ...
            $(document).on('change', '.slider2', function(e) {
                if ($(this).val() == 1) {
                    ...
                    $('#harmonized_tag_edit').removeClass('d-none');
                    $('#federal_tag_edit').addClass('d-none');
                    ...
                    $('#harmonized_tag_edit').addClass('d-none');
                    $('#federal_tag_edit').removeClass('d-none');
                } else {
            ...
            $('#form-add-tax').submit(function(e) {
                ...
                var tax_label_2 = $('input[name=tax_label_2]').val()
                var tax_rate_2 = $('input[name=tax_rate_2]').val()
                var tax_label_1 = $('input[name=tax_label_1]').val()
                var tax_rate_1 = $('input[name=tax_rate_1]').val()
                var tele_regex = /^.{0,4}$/;
                if (province == '') {
                    $('select[name=province]').select2('open')
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                ...
                if (tax_label_1 == '' && (slider == 2 || slider == 1)) {
                    $('input[name=tax_label_1]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Label 1.',
                        delay: 5000
                    });
                } else if (!tele_regex.test(tax_label_1) && (slider == 2 || slider == 1)) {
                    $('input[name=tax_label_1]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Tax Label 1 should be max 4 chars.',
                        delay: 5000
                    });
                } else if (tax_rate_1 == '' && (slider == 2 || slider == 1)) {
                    $('input[name=tax_rate_1]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Rate 1.',
                        delay: 5000
                    });
                } else if (tax_label_2 == '' && (slider == 2)) {
                    $('input[name=tax_label_2]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Label 2.',
                        delay: 5000
                    });
                } else if (!tele_regex.test(tax_label_2) && (slider == 2)) {
                    $('input[name=tax_label_2]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Tax Label 2 should be max 4 chars.',
                        delay: 5000
                    });
                } else if (tax_rate_2 == '' && (slider == 2)) {
                    $('input[name=tax_rate_2]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Rate 2.',
                        delay: 5000
                    });
                } else {
            ...
            $(document).on('click', '.btnDelete', function(e) {
                ...
                var c = confirm("Are you sure want to delete this Tax Rate");
                if (c) {
                    window.location.href = "{{ url('delete-tax') }}?id=" + id;
                }
            })
 ...
 <a href="{{ asset('public/temp_uploads/${attachmentArray[i].attachment}') }}" target="_blank"    class="   attachmentDivNew comments-section-text"><img src="{{ asset('public/img/${icon}') }}" width="25px"> &nbsp;${attachmentArray[i].attachment.substring(0,19)}...
            ...
            $(document).on('click', '.saveContract', function() {
                ...
                var slider = $('#slider2').val();
                var tax_label_2 = $('input[name=tax_label_2_edit]').val()
                var tax_rate_2 = $('input[name=tax_rate_2_edit]').val()
                var tax_label_1 = $('input[name=tax_label_1_edit]').val()
                var tax_rate_1 = $('input[name=tax_rate_1_edit]').val()
                var tele_regex = /^.{0,4}$/;
                if (province == '') {
                    $('select[name=province_edit]').select2('open');
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Province.',
                ...
                if (tax_label_1 == '' && (slider == 2 || slider == 1)) {
                    $('input[name=tax_label_1_edit]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Label 1.',
                    ...
                    $('input[name=tax_rate_1_edit]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Rate 1.',
                    ...
                    $('input[name=tax_label_2_edit]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Label 2.',
                    ...
                    $('input[name=tax_rate_2_edit]').focus();
                    Dashmix.helpers('notify', {
                        from: 'bottom',
                        align: 'left',
                        message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="24px"  > Please enter value for Tax Rate 2.',
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        success: function(res) {
                            window.location.href = "{{ url('/taxes') }}?id=" + data1;
                            //$("#JournalHeader").removeClass('d-none');
                            //Dashmix.helpers('notify', {from: 'bottom',align: 'left',message: 'Tax Rate successfully saved', delay: 5000});
                            //showData(data1)
                            click = 0;
        ...
        $(document).ready(function() {
            $(document).on('click', '.undo-delete', function() {
                var id = $(this).attr('data');
                window.location.href = "{{ url('undo-delete-tax') }}?id=" + id;
            });
        });
        $(document).ready(function() {
            ...
            $(document).on('shown.bs.modal', '#AddTaxModal', function() {
                $('#AddTaxModal select[name=province]').select2('open');
            });
        ...
        $(document).on({
            mouseenter: function() {
                ...
                let label = $('input[name=' + data + ']').val();
                if (label == '') {
                    label = 'Tax1';
                }

                $(this).tooltip({
                    title: 'Apply on ' + label,
                    placement: 'top',
                    container: 'body',
                    customClass: 'tax-tooltip'
                });
                $(this).tooltip('show');
            },
            mouseleave: function() {
