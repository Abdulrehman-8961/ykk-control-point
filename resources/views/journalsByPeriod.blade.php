                        ...
                        <div class="row">
                            <div class="col-8 search-col row" style="position: relative;">
                                <div class="d-flex align-items-center" style="padding-left: 20px;">
                                    <img src="{{ asset('public/img/gl-menu-icons/enquiry-by-period-white.png') }}"
                        ...
                        <div class="TopArea" style="padding-top: 11px;z-index: 0;padding-bottom: 9px;">
                            <div class="container-fluid row px-0">
                                <div class="float-left search-col row d-flex flex-nowrap align-items-center"
                                    ...
                                    <div class="text-center mr-2 px-2 sortable" data-column="j.editNo" data-order="asc"
                                    ...
                                    <div class="text-center mr-2 px-2 sortable" data-column="j.date" data-order="asc"
                                    ...
                                    <div class="text-center mr-2 px-2 sortable" data-column="j.account_no" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 70px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">AcctNo</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="sc.source_code" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 70px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Source</a>
                                    </div>
                                    <div class="text-center mr-2 px-2 sortable" data-column="j.ref_no" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 100px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">RefNo</a>
                                    </div>
                                    <div class="text-right mr-2 px-2 sortable" data-column="j.debit" data-order="asc"
                                    ...
                                    <div class="text-right mr-2 px-2 sortable" data-column="j.credit" data-order="asc"
                                        style="background: #f2f2f2; padding-top: 7px; padding-bottom: 7px; border-radius: 10px; width: 140px; border: 1px solid #ECEFF4;">
                                        <a href="javascript:void();"
                                            style="text-decoration: none;color: #595959 !important; font-family: Signika !important;">Credit</a>
                                    </div>
                                    <div class="text-left mr-2 px-2 sortable" data-column="j.description" data-order="asc"
                    ...
                    <div class="modal-content">
                        <div class="block  block-transparent mb-0">
                            ...
                            <div class="block-content new-block-content pt-0 pb-0 ">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <p>Would you like to export ALL periods?</p>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        `;
            ...
            function getContent() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ url('/journal/load-content-by-period') }}",
                    data: {
                        "client_id": client_id,
                        "client_fyear": client_fyear,
                        "period": period,
