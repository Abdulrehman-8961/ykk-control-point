...
function findJournalIn($filters, $period, $account, $source)
{
    ...
    $sourceFiltersApplied = @$_GET['report_source'] ?? [];
        $accountFiltersApplied = @$_GET['report_account'] ?? [];
?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 " style="    padding-left: 4rem!important;">
                                        <table class="table border-0 table-period">
                                            <thead>
                                                <tr>
                                                    <td style="font-weight:600;padding:0;border:0 !important;">EN</td>
                                                    <td style="font-weight:600;padding:0;border:0 !important;">Src</td>
                                                    <td style="font-weight:600;padding:0;border:0 !important;">Acct
                                                    </td>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="padding:0;border:0 !important;">{{$j->editNo}}</td>
                                                ...
                                                <tr>
                                                    <td colspan="5"
                                                        ...
                                                        <span class="tags">Sources: @if (count($sourceFiltersApplied) > 0) @foreach($sources as
                                                            $s){{$s->source_code.','}} @endforeach @endif</span><br>
                                                        <span class="tags">Accounts: @if (count($accountFiltersApplied) > 0) @foreach ($accounts as $a)
                                                            {{$a->account_no. ','}}
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="font-weight: 600;padding:0;border:0" class="text-right">
                                            ...
                                            strtotime(getFiscalYearEnd($client->fiscal_start)))}} Total</td>
                                        </td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 " style="    padding-left: 4rem!important;">
                                            <table class="table border-0 table-period">
                                                <thead>
                                                    <tr>
                                                        <td style="font-weight:600;padding:0;border:0 !important;">EN
                                                        </td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="5"
                                                            ...
                                                            <span class="tags">Sources: @if (count($sourceFiltersApplied) > 0) @foreach($sources as
                                                                $s){{$s->source_code.','}} @endforeach @endif</span><br>
                                                            <span class="tags">Accounts: @if(count($accountFiltersApplied) > 0) @foreach ($accounts as
                                                                $a)
                                                                {{$a->account_no. ','}}
                                                                @endforeach @endif</span>
                                                        </td>
                                            ...
                                            <div class="col-sm-12 " style="    padding-left: 4rem!important;">
                                                <table class="table border-0 table-period">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td style="padding:0;border:0 !important;">{{$j->editNo}}
                                                            </td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td colspan="5"
                                                                ...
                                                                <span class="tags">Sources: @if (count($sourceFiltersApplied) > 0) @foreach($sources as
                                                                    $s){{$s->source_code.','}} @endforeach @endif</span><br>
                                                                <span class="tags">Accounts: @if (count($accountFiltersApplied) > 0) @foreach ($accounts
                                                                    as
                                                                    $a)
                                                                    {{$a->account_no. ','}}
                                                                    @endforeach @endif</span>
