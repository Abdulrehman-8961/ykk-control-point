                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                <div class="d-flex">
                                <img src="{{asset('public/img/headr-certificate-white.png')}}" width="40px">
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">New SSL Certificate</h4>
...
<div class="contract_type_button ">
  <input type="radio" id="a75" name="cert_type" checked   value="internal"/>
  <label class="btn btn-new " for="a75"  >Internal</label>
</div>
<div class="contract_type_button">
  <input type="radio" id="a50" name="cert_type" value="public"/>
  <label class="btn btn-new ml-5" for="a50"   >Public</label>
</div>
    ...
    <div class="block new-block PublicDiv d-none" >
                                            ...
                                            <div class="col-sm-5">
                                                  <select   type="text" class="form-control select2"    id="cert_issuer" name="cert_issuer" placeholder=""  > 
                                                       ...
                                                       @foreach($use as $u)
                                                            ...
                                                            <option value="{{$u->id}}" >{{$u->vendor_name}}</option>
                                                        @endforeach
                     ...
                     name="cert_rdate" placeholder="Y-M-d" data-alt-input="true"     data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
                                        </div>
                                        <div class="row form-group ">
                                                <label class="col-sm-2 mandatory  col-form-label" for="example-hf-email">MSRP</label>
                                            <div class="col-sm-4">
                                              <input type="number" step="any" class="form-control"     id="cert_msrp" name="cert_msrp" placeholder=""  > 
                                            </div>
                                        </div>
   ...
   <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group ">
                                            ...
                                            <div class="col-sm-4">
                                                      <input type="text" class="form-control"  id="cert_name"   name="cert_name" placeholder=""  > 
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                         <input type="text" class="js-flatpickr form-control bg-white" id="cert_edate" 
                                                          name="cert_edate" placeholder="Y-M-d" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4">
                                                  <input type="text" class="form-control"  id="cert_company"   name="cert_company" placeholder=""  > 
                                            </div>
                                                    <label class="col-sm-2    col-form-label" for="example-hf-email">  Department(OU)  </label>
                                            <div class="col-sm-4">
                                                       <input type="text" class="form-control"  id="cert_department"    name="cert_department" placeholder=""  > 
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4">
                                                  <input type="text" class="form-control"  id="cert_city"  name="cert_city" placeholder=""  > 
                                            </div>
                                                    <label class="col-sm-2   mandatory col-form-label" for="example-hf-email">  State (S)  </label>
                                            <div class="col-sm-4">
                                                       <input type="text" class="form-control"  id="cert_state"   name="cert_state" placeholder=""  > 
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4">
                                                   <input type="text" class="form-control"  id="cert_country" name="cert_country"   placeholder=""  > 
                                            </div>
                                                    <label class="col-sm-2    col-form-label" for="example-hf-email">  Email (E)  </label>
                                            <div class="col-sm-4">
                                                       <input type="email" class="form-control"  id="cert_email"   name="cert_email" placeholder=""  > 
                                            </div>
                                        </div>
 ...
 <button type="button" class="btn ml-5 btn-new float-right mt-4 " data-toggle="modal" data-target="#HostModal">Assign certificate to hosts</button>
</div>
...
$.ajax({
    type:'post',
    data:formData,
    'url':'{{url('insert-ssl-certificate')}}',
    dataType:'json',
    async:false,
...
if(data1==0){
        ...
        Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Certificate Succesfully added', delay: 5000});

       
     window.location.href=unEntity('{{URL::previous()==URL::full()?url('ssl-certificate'):URL::previous()}}');
}else{
      Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Certificate Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding certificate</span>', delay: 5000});
}
