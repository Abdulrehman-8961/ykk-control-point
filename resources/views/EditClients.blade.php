  ...
  @section('content')
          ...
          <div class="block card-round   bg-new-blue new-nav">
              <div class="block-header   py-new-header">
                  <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                      <div class="d-flex">
                          <img src="{{ asset('public/img/header-white-client.png') }}" width="40px">
                          <div class="ml-4">
                              <h4 class="mb-0 header-new-text" style="line-height:25px">Edit
                                  {{ $qry->client_status == 1 ? 'Active' : 'Inactive' }} Client</h4>
                      ...
                      <div class="new-header-icon-div">
                          ...
                          <a href="javascript:;" class="text-white saveContract" data="0" data-toggle="tooltip"
                              data-trigger="hover" data-placement="top" title="" data-original-title="Save User"><i
    ...
    padding-right: 15mm;">
              ...
              <form id="form-1" action="{{ url('insert-client') }}" class="js-validation   " method="POST"
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-2">
                                                  <select type="text" class="form-control" id="salutation"
                                                      name="salutation" placeholder="Salutation">
                                                      <option value="Mr" {{ $qry->salutation == 'Mr' ? 'selected' : '' }}>Mr.
                                                      </option>
                                                      <option value="Mrs" {{ $qry->salutation == 'Mrs' ? 'selected' : '' }}>
                                                          Mrs.</option>
                                                      <option value="Ms" {{ $qry->salutation == 'Ms' ? 'selected' : '' }}>Ms.
                                                      </option>
                                                      <option value="Miss" {{ $qry->salutation == 'Miss' ? 'selected' : '' }}>
                                                          Miss.</option>
                                                      <option value="Dr" {{ $qry->salutation == 'Dr' ? 'selected' : '' }}>Dr.
                                                      </option>
                                                  </select>
                                              </div>
                                              <div class="col-sm-4 form-group">
                                                  <input type="text" class="form-control" id="firstname"
                                                      name="firstname" value="{{ $qry->firstname }}">
                                              </div>
                                              <div class="col-sm-4  ">
                                                  <input type="text" class="form-control" id="lastname"
                                                      name="lastname" value="{{ $qry->lastname }}">
                                              </div>
                                          </div>
                                      </div>
                                      <div class="col-lg-8">
                                          <div class="form-group row">
                                              <label class="col-sm-3  col-form-label mandatory"
                                                  for="example-hf-client_id">Company Name</label>

                                              <div class="col-sm-9  form-group">
                                                  <input type="text" class="form-control" id="company_name"
                                                      name="company_name" value="{{ $qry->company_name }}">
                                              </div>
                                          ...
                                          <div class="form-group row ">
                                              ...
                                              <div class="col-sm-9  form-group">
                                                  <input type="text" class="form-control"
                                                      value="{{ $qry->firstname }}" id="firstname" name="firstname">
                                              </div>
                                      ...
                                      <div class="col-lg-4">
                                          <div class="avatar-upload">
                                              <div class="avatar-edit">
                                                  <input type='file' id="imageUpload1" name="logo"
                                                      accept=".png, .jpg, .jpeg" />
                                                  <label for="imageUpload1"></label>
                                              </div>
                                              <div class="avatar-preview">
                                                  <div id="imagePreview1"
                                                      style="background-image: url('{{ asset('public/client_logos/') }}/{{ $qry->logo }}');">
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
                                      <input type="hidden" value="{{ $qry->logo }}" name="hidden_img">

                                      <div class="col-lg-12">
                                          <div class="form-group row">
                                              <label class="col-sm-2 mandatory col-form-label"
                                                  for="example-hf-email">Email Address </label>
                                              <div class="col-sm-6  form-group">
                                                  <input type="email" class="form-control"
                                                      value="{{ $qry->email_address }}" id="email" name="email">
                                              </div>
                                          </div>

                                          <div class="form-group row">
                                              <label class="col-sm-2   col-form-label" for="example-hf-email">Telephone
                                              </label>
                                              <div class="col-sm-3  form-group">
                                                  <input type="" class="form-control" id="work_phone"
                                                      name="work_phone" value="{{ $qry->work_phone }}">
                                              </div>
                                              <label class="col-sm-2 text-center   col-form-label"
                                                  for="example-hf-email">Fax </label>
                                              <div class="col-sm-3">
                                                  <input type="" class="form-control" id="mobile"
                                                      value="{{ $qry->mobile }}" name="mobile">
                                              </div>
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <div class="col-sm-6">
                                                  <input type="url" class="form-control" value="{{ $qry->website }}"
                  ...
                  <div class="block new-block   ">
                      ...
                      <div class="block-header py-0" style="padding-left:7mm;">
                          ...
                          <a class="  section-header">Client Address
                      ...
                      <div class="block-content new-block-content">
                          ...
                          <div class="row form-group ">
                              ...
                              <div class="col-sm-6">
                                  <select type="text" class="form-control select2" id="country" name="country"
                                      placeholder="">
                                      ...
                                      @foreach ($use as $u)
                                          <option value="{{ $u->name }}"
                                              {{ $qry->country == $u->name ? 'selected' : '' }}>{{ $u->name }}</option>
                                      @endforeach
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-6">
                                  <textarea class="form-control" id="client_address" name="client_address">{{ $qry->client_address }}</textarea>
                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                              <label class="col-sm-2 mandatory col-form-label"
                                  for="example-hf-email">State/Province</label>
                              <div class="col-sm-6">
                                  <input class="form-control" id="state" value="{{ $qry->state }}"
                                      name="state">
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-sm-2 mandatory col-form-label" for="example-hf-email">Zip/Postal
                                  Code</label>
                              <div class="col-sm-6">
                  ...
                  <div class="block new-block">
                      ...
                      <div class="block-header py-0" style="padding-left:7mm;">
                          ...
                          <a class="  section-header">Contract Renewal Notifications
                      ...
                      <div class="block-content new-block-content">
                          ...
                          <div class=" row mb-3">
                              ...
                              <div class="col-sm-6">
                                  <div class="custom-control custom-switch custom-control-warning custom-control-lg mt-2 ">
                                      <input type="checkbox" class="custom-control-input" id="contract_notification"
                                          name="contract_notification" value="1"
                                          {{ $qry->renewal_notification == 1 ? 'checked' : '' }}>
                          ...
                          <div id="ContractEmailBlock"
                              class="ContractEmailHide {{ $qry->renewal_notification == 1 ? '' : 'd-none' }}">


                          </div>

                          <button type="button" data-toggle="modal" data-target="#ContractEmailModal"
                              class="btn ContractEmailHide {{ $qry->renewal_notification == 1 ? '' : 'd-none' }} ml-5 mt-3 btn-new ">Add
                  ...
                  <div class="block new-block">
                      ...
                      <div class="block-header py-0" style="padding-left:7mm;">
                          ...
                          <a class="  section-header">SSL Certificate Renewal Notifications
                      ...
                      <div class="block-content new-block-content">
                              ...
                              <div class="col-sm-6">
                                  <div class="custom-control custom-switch custom-control-warning custom-control-lg mt-2 ">
                                      <input type="checkbox" class="custom-control-input" id="cert_notification"
                                          name="cert_notification" value="1"
                                          {{ $qry->ssl_notification == 1 ? 'checked' : '' }}>
                          ...
                          <div id="EmailBlock" class="EmailHide {{ $qry->ssl_notification == 1 ? '' : 'd-none' }}">


                          </div>

                          <button type="button" data-toggle="modal" data-target="#EmailModal"
                              class="btn EmailHide ml-5 mt-3 {{ $qry->ssl_notification == 1 ? '' : 'd-none' }} btn-new ">Add
                              Email Address</button>
                      </div>
                  </div>
                      ...
                      <div class="block-content new-block-content pt-0 pb-0 ">
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-10   form-group      ">
                                  ...
                                  <div class="contract_type_button ">
                                      <input type="radio" id="dns1" name="san_type_edit" checked
                                          value="DNS" />
      ...
      <div class="modal fade" id="HostModal" tabindex="-1" role="dialog" data-backdrop="static"
          aria-labelledby="modal-block-large" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg modal-bac " role="document">
              <div class="modal-content">
                  <div class="block  block-transparent mb-0">
                      ...
                      <div class="block-content new-block-content pt-0 pb-0 ">
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-10   form-group      ">
                                  <select type="" class="form-control selectpicker" data-live-search="true"
                                      id="hostname" value="" name="cert_hostname">
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-10   form-group      ">
                                  ...
                                  <div class="contract_type_button mr-5 mb-3">
                                      <input type="checkbox" class="ip_type primary_ip" id="ip_primary" name="ip_type[]"
                                          value="Primary" />
                  ...
                  <div class="block  block-transparent mb-0">
                      ...
                      <div class="block-content new-block-content pt-0 pb-0 ">
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-10   form-group      ">
                                  <select type="" class="form-control selectpicker" data-live-search="true"
                                      id="hostname_edit" value="" name="cert_hostname_edit">
                                      <option value="">Select Hostname</option>
                                  </select>
                              </div>
                          </div>
  ...
  <script type="text/javascript">
      $(function() {
          ...
          var email_key_count_contract = 0;
          ...
          $.ajax({
              ...
              url: "{{ url('get-email-contract-clients') }}",
              success: function(res) {
                  for (var i = 0; i < res.length; i++) {

                      ContractemailArray.push({
                          key: i,
                          email: res[i].renewal_email
                      });
                      email_key_count_contract = i;
                  }
                  showContractEmail();
          ...
          $('#HostSave').click(function() {
              ...
              if (host == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> You must select a hostname.',
                      delay: 5000
                  });

              } else if (ip.length == 0) {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> You must select at least one IP.',
                      delay: 5000
                  });
          ...
          $('#HostSaveEdit').click(function() {
              ...
              var asset_description = $('option:selected', $('select[name=cert_hostname_edit')).attr(
                  'data');
          ...
          $(document).on('click', '.btnEditHost', function() {
              ...
              $('select[name=cert_hostname_edit]').selectpicker('refresh')
              $('.primary_ip_edit').attr('data', $('option:selected', $(
                  'select[name=cert_hostname_edit]')).attr('data2'));
          ...
          $(document).on('click', '.btnDeleteHost', function() {
              ...
              Dashmix.helpers('notify', {
                  message: '<img src="{{ asset('public/img/green-check.png') }}" width="30px" class="mt-n1"> Host unassigned. <a href="javascript:;" class="  btn-notify btnHostUndo ml-4" data1=' +
                      id + ' data=' + key + '>Undo</a>',
                  delay: 5000
              });
              showHost();
          ...
          $('#contractDetailsSave').click(function() {
              ...
              if (san == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1">  Please enter a value for SAN',
                      delay: 5000
                  });
          ...
          $(document).on('click', '.btnEditContract', function() {
              ...
              $('input[name=san_type_edit][value=' + contractDetailsArray[id].san_type + ']').prop(
                  'checked', true)
          ...
          $(document).on('click', '.btnDeleteContract', function() {
              ...
              Dashmix.helpers('notify', {
                  align: 'center',
                  message: '<img src="{{ asset('public/img/green-check.png') }}" width="30px" class="mt-n1"> SAN Deleted. <a href="javascript:;" class="  btn-notify btnContractUndo ml-4" data1=' +
                      id + ' data=' + key + '>Undo</a>',
                  delay: 5000
              });
              showcontractDetails();
 ...
 <a href="{{ asset('public/temp_uploads/${attachmentArray[i].attachment}') }}" target="_blank"    class="   attachmentDivNew comments-section-text"><img src="{{ asset('public/img/${icon}') }}" width="25px"> &nbsp;${attachmentArray[i].attachment.substring(0,30)}...
          ...
          $('.btnClose').click(function() {
              if (click == 1) {
                  ...
                  window.location.href = unEntity(
                      '{{ URL::previous() == URL::full() ? url('clients') : URL::previous() }}');
          ...
          $('.saveContract').click(function() {
              ...
              if (salutation == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please select a value for salutation.',
                      delay: 5000
                  });

              } else if (firstname == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please select a value for firstname.',
                      delay: 5000
                  });

              } else if (lastname == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for lastname.',
                      delay: 5000
                  });

              } else if (company_name == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for company name.',
                      delay: 5000
                  });

              } else if (firstname == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for display name.',
                      delay: 5000
                  });

              } else if (email == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for email.',
                      delay: 5000
                  });

              } else if (country == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please select a value for country.',
                      delay: 5000
                  });

              } else if (client_address == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for address.',
                      delay: 5000
                  });

              } else if (city == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please select a value for city.',
                      delay: 5000
                  });

              } else if (state == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for state.',
                      delay: 5000
                  });

              } else if (zip == '') {
                  Dashmix.helpers('notify', {
                      message: '<img src="{{ asset('public/img/warning-yellow.png') }}" width="30px" class="mt-n1"> Please enter a value for zip.',
                      delay: 5000
                  });
                  ...
                  for (var i = 0; i < emailArray.length; i++) {
                      formData.append('ssl_certificate_email[]', JSON.stringify(emailArray[i]));
                  }
                  for (var i = 0; i < ContractemailArray.length; i++) {
                      formData.append('notification_renewal_email[]', JSON.stringify(ContractemailArray[
                          i]));
                  }
                  ...
                  $.ajax({
                      ...
                      success: function(res) {
                          ...
                          if (data1 == 0) {
                              ...
                              Dashmix.helpers('notify', {
                                  align: 'center',
                                  message: '<img src="{{ asset('public/img/green-check.png') }}" width="30px" class="mt-n1"> Client Succesfully updated',
                                  delay: 5000
                              });
                              ...
                              Dashmix.helpers('notify', {
                                  align: 'center',
                                  message: '<img src="{{ asset('public/img/green-check.png') }}" width="30px" class="mt-n1"> Client Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue updated client</span>',
                                  delay: 5000
                              });
                          }
          ...
          $('#client_id').change(function() {
              ...
              if (address != '' || logo != '') {
                  $('#clientInfo').html('<div class="col-sm-8">' +
                      ...
                      '<div class="font-size-sm text-muted" style="white-space: pre-line;">' +
                      address + '</div>' +
                      '</div>' +
                      '<div class="ml-3">' +
                      '<img class="img-avatar" src="{{ asset('public/client_logos/') }}/' + logo +
                      '" alt="">' +
              ...
              $.ajax({
                  ...
                  success: function(res) {
                      ...
                      for (var i = 0; i < res.length; i++) {
                          html += '<option value=' + res[i].id + ' data="' + res[i].role +
                              '"  data1="' + res[i].asset_icon + '" data2="' + res[i]
                              .ip_address + '">' + res[i].hostname.toUpperCase() +
                              '</option>';
                      }
