                                                    ...
                                                    <td colspan="2"  class="pt-0" style="vertical-align: top;" >
                                                       <div class="pl-2  mb-0 row  "> ';
                                                                    ...
                                                                    foreach($line_item as $l){
                                                                                if($l->AssetStatus!=1){
                                                                                      $html.='  <div class="col-lg-2   px-2"><a href="print-asset?id='.$l->id.'" target="_blank"><div data-toggle="tooltip" data-trigger="hover" data-html="true" data-original-title="'.$l->asset_type_description.($l->asset_type=='physical'?'<br>'.$l->sn:'').'" title="" class="w-100   AssetInactive">'.$l->hostname.'</div></a></div>';
                                                                                }else{
                                                                                    $html.='<div class="col-lg-2   px-2"><a href="print-asset?id='.$l->id.'" target="_blank"><div data-toggle="tooltip" data-trigger="hover" data-html="true" data-original-title="'.$l->asset_type_description.($l->asset_type=='physical'?'<br>'.$l->sn:'').'" title="" class="w-100   AssetActive">'.$l->hostname.'</div></a></div>';
                                                                                }
                                                                                }
