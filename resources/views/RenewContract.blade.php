         ...
         $renewed_qry=DB::Table('users')->Where('id',$qry->renewed_by)->first(); 
             ...
             ?>
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">Renewing Contract</h4>
                               <p class="mb-0  header-new-subtext" style="line-height:15px">On {{date('Y-M-d H:i:s A')}}  </p>
                                    </div>
                                </div>
                                   ...
                                   <!--         <a href="javascript:;"  class="saveContract text-white"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Renew and Continue"  class="text-white"><i class="fa fa-plus texti-white"  ></i> </a>
  -->
                                              <a href="javascript:;" class="text-white saveContract" data="0" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Renew Contract"><i class="fa fa-check text-white"   ></i> </a>
  ...
  <label class="btn btn-new ml-5" for="a25" > Subscription</label>
                                  ...
                                  <div class="row form-group ">
                                            ...
                                            <div class="col-sm-4  ">
                                                     ...
                                                     <input type="text" class="js-flatpickr form-control bg-white" id="contract_start_date" value="{{$qry->contract_end_date}}" name="contract_start_date" placeholder="" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d" >
                                            </div>
                                       
                                              <label class="col-sm-2 col-form-label text-md-center mandatory  " for="example-hf-email">End Date</label>
                                            <div class="col-sm-4   ">
                           
                                         <input type="text" class="  form-control bg-white" id="contract_end_date" name="contract_end_date"    value=""  placeholder="" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
        ...
        <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                  ...
                                  <option value="{{$c->id}}"  data-logo="{{$c->distributor_image}}"  {{$qry->distributor_id==$c->id?'selected':''}} >{{$c->distributor_name}}</option>
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control"  id="reference_no" name="reference_no"    placeholder=" "  > 
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control"  id="distrubutor_sales_order_no" name="distrubutor_sales_order_no"    placeholder=" "  > 
                                            </div>
          ...
          <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                            ...
                                            <div class="col-sm-4">
                                                 <input type="text" class="form-control"  id="estimate_no" name="estimate_no"     placeholder=" "  > 
                                            </div>
                                          
                                    
                                            <label class="col-sm-2 col-form-label text-md-center" for="example-hf-email">Sales Order #</label>
                                            <div class="col-sm-4">
                                                 <input type="text" class="form-control"  id="sales_order_no" name="sales_order_no"   placeholder=""  > 
                                            </div>
                     ...
                     <input type="text" class="js-flatpickr form-control bg-white" id="invoice_date"    name="invoice_date" placeholder="Y-M-d" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-sm-4 form-  ">
                                                 <input type="text" class="form-control"  id="po_no"    name="po_no" placeholder=""  > 
                                            </div>
                         ...
                         <input type="text" class="js-flatpickr form-control bg-white" id="po_date"  name="po_date" placeholder="Y-M-d" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
...
var coned=$('#contract_end_date').flatpickr()
coned.open();
...
$(document).on('click','.btnDeleteEmail',function(){
    ...
    Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Email address Deleted. <a href="javascript:;" class="  btn-notify btnEmailUndo ml-4" data1='+id+' data='+key+'>Undo</a>', delay: 5000}); 
showEmail();
...
$(document).on('click','.btnDeleteContract',function(){
    ...
    Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Contract details Deleted. <a href="javascript:;" class="  btn-notify btnContractUndo ml-4" data1='+id+' data='+key+'>Undo</a>', delay: 5000}); 
showcontractDetails();
...
$.ajax({
    ...
    success:function(res) {
        ...
        Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Contract Saved Succesfully', delay: 5000});
