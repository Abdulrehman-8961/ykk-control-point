                        ...
                        <div class="hero-static col-md-12 d-flex align-items-center" style="background-color: #f0f3f8!important;">
                            <div class="p-3 w-100">
                                ...
                                <div class="login-content">
                                        <form class="js-validation-signin" action="{{url('/change-password')}}" method="POST">
                                            @csrf
                                            <div class="pt-3">
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-lg form-control-alt  @error('new_password') is-invalid @enderror" id="new_password" name="new_password" placeholder="New Password">
                                                    
                                                </div>
                                                <div class="form-group">
                                                    <input type="password" class="form-control form-control-lg form-control-alt  @error('confirm_password') is-invalid @enderror" id="confirm_password" name="confirm_password" placeholder="Confirm New Password">
