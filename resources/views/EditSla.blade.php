...
if(Auth::user()->role=='read'){
 ...
 $qry=DB::table('sla')->where('id',$_GET['id'])->first();
                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                <div class="d-flex">
                                <img src="{{asset('public/img/header-white-sla.png')}}" width="40px">
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">Edit Sla</h4>
                                    ...
                                    <div class="new-header-icon-div">
                                         <span data-toggle="modal" data-bs-target="#AttachmentModal" data-target="#AttachmentModal" > 
                                             ...
                                             <a  href="javascript:;"   data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Add Comment"><img src="{{asset('public/img/comment-white.png')}}" width="20px"></a>
                                              ...
                                              <a href="javascript:;" class="text-white saveContract"  data="0"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save Sla"><i class="fa fa-check text-white"   ></i> </a>
   ...
   <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group ">
                                            ...
                                            <div class="col-sm-4">
                                                      <input type="text" class="form-control"  id="sla_description"   name="sla_description"  value="{{$qry->sla_description}}" placeholder=""  > 
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                  <input type="color" class="form-control"  id="tag_text_color" value="{{$qry->tag_text_color}}" name="tag_text_color" placeholder=""  > 
                                                          ...
                                                          <div class="col-sm-2">
                                                 <div style="box-shadow:none;padding-bottom: 0px;padding-top:0px;min-height:29px;width:!important;border-radius:5px;background:{{$qry->tag_back_color}};color:{{$qry->tag_text_color}}" class=" text-center px-2 border-none  font-size-md badgeAuto  bubble-white-new bubble-text-sec">{{$qry->sla_description}}</div>
                                                 <div>
...
var data1=$(this).attr('data');
        var sla_description=$('#sla_description').val();
...
if(data1==0){
        ...
        Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Sla Succesfully updated', delay: 5000});

       
   //  window.location.href=unEntity('{{URL::previous()==URL::full()?url('sla'):URL::previous()}}');
}else{
      Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Sla Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding Sla Type</span>', delay: 5000});
}
