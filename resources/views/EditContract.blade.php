...
@section('content')
<?php
$qry=DB::Table('contracts')->where('id',$_GET['id'])->first();
$type=$qry->contract_type; 
        ...
        display: none;
          ...
          <!-- Main Container -->
            <main id="main-container  " style="padding:3mm">
                <!-- Hero -->
             <?php $contract_end_date=date('Y-M-d',strtotime($qry->contract_end_date)); 
             $today=date('Y-m-d');
...
$abs_diff = $later->diff($earlier)->format("%a"); //3
                    ...
                    @if($qry->contract_status=='Active')
                          ...
                          <img src="{{asset('public/img/icon-upcoming-removebg-preview.png')}}" width="40px">
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                @endif
                                @elseif($qry->contract_status=='Inactive')
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <p class="mb-0  header-new-subtext" style="line-height:15px">On {{date('Y-M-d',strtotime($qry->ended_on))}} at  {{date('H:i:s A',strtotime($qry->ended_on))}} By {{@$ended_qry->firstname.' '.@$ended_qry->lastname}}: {{substr($qry->ended_reason,0,50)}}...</p>
                                    </div>
                                </div>
                                @elseif($qry->contract_status=='Ended')
                                    <div class="block card-round   bg-new-red new-nav" >
                                <div class="block-header   py-new-header" >
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                @elseif($qry->contract_status=='Expired')
                                    <div class="block card-round   bg-new-red new-nav" >
                                <div class="block-header   py-new-header" >
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                @endif
                                    ...
                                    <div class="new-header-icon-div">
                                        ...
                                        <!--    <a href="javascript:;"  class="saveContract text-white" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save and Close"  class="text-white"><i class="fa fa-plus texti-white"  ></i> </a> -->
 
                                              <a href="javascript:;" class="text-white saveContract"  data="0"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save Contract"><i class="fa fa-check text-white"   ></i> </a>
    ...
    padding-right: 15mm;">
                    <!-- New Post -->
                    <form  id="form-1" action="{{url('update-contract')}}" class="js-validation   " method="POST" enctype="multipart/form-data"  >
                        @csrf
                      <input type="hidden" name="id" value="{{$qry->id}}">
                        <input type="hidden" name="attachment_array" id="attachment_array"  value="{{$qry->attachment}}">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="cert_notification" name="contract_notification" value="1" {{$qry->contract_notification==1?'checked':''}}>
      ...
      <input type="email" class="form-control" id="renewal_notification_email"   name="notification_renewal_email[]"  placeholder="Email 1"  > 
                                                ...
                                                <div id="EmailBlock" class="EmailHide {{$qry->contract_notification!=1?'d-none':''}}">  
                                                     
                               
                                                   </div>

                                                    <button type="button" data-toggle="modal" data-target="#EmailModal" class="btn EmailHide {{$qry->contract_notification!=1?'d-none':''}} ml-5 mt-3 btn-new ">Add Email Address</button>
    ...
    <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group ">
                                                         <label class="col-sm-2  mandatory col-form-label" for="example-hf-email">Description </label>
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control" req  id="contract_description" name="contract_description" placeholder=" "  value="{{$qry->contract_description}}" >   
                                            </div>
                                        </div>
...
<div class="contract_type_button ">
  <input type="radio" id="a75" name="contract_type"     {{$qry->contract_type=='Software Support'?'checked':''}}  value="Software Support"/>
  <label class="btn btn-new " for="a75">Software Support</label>
</div>
<div class="contract_type_button">
  <input type="radio" id="a50" name="contract_type" value="Hardware Support" {{$qry->contract_type=='Hardware Support'?'checked':''}}/>
  <label class="btn btn-new ml-5" for="a50"  >Hardware Support</label>
</div>

                                   <div class="contract_type_button">
  <input type="radio" id="a25" name="contract_type"  value="Subscription" {{$qry->contract_type=='Subscription'?'checked':''}}/>
  <label class="btn btn-new ml-5" for="a25" > Subscription</label>
</div>
                                            ...
                                            $vendor=DB::Table('vendors')->where('is_deleted',0)  ->orderBy('vendor_name','asc')->get();
                                             ?>
                                            <div class="col-sm-5">
                                                 <select type="" class="form-control select2" id="vendor_id"  value="" name="vendor_id"   >
                                                    <option value=""  data-logo=""> </option>
                                                         @foreach($vendor as $c)
                                                    <option value="{{$c->id}}" data-logo="{{$c->vendor_image}}"   {{$qry->vendor_id==$c->id?'selected':''}}>{{$c->vendor_name}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-sm-2 mandatory col-form-label" for="example-hf-email">Contract  / Ref #</label>
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control"  id="contract_no"   value="{{$qry->contract_no}}" name="contract_no" placeholder=""  > 
                                            </div>
                                        </div>
                                        <div class="row form-group ">
                                                <label class="col-sm-2 mandatory  col-form-label" for="example-hf-email">End User Email</label>
                                            <div class="col-sm-10">
                                                 <input type="email" class="form-control"  id="registered_email"  value="{{$qry->registered_email}}" name="registered_email" placeholder=""  > 
                                            </div>
                                        </div>
                                  <div class="row form-group ">
                                            ...
                                            <div class="col-sm-4  ">
                                                     ...
                                                     <input type="text" class="js-flatpickr form-control bg-white" id="contract_start_date"  value="{{$qry->contract_start_date}}" name="contract_start_date" placeholder="" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d" >
                                            </div>
                                       
                                              <label class="col-sm-2 col-form-label text-md-center mandatory  " for="example-hf-email">End Date</label>
                                            <div class="col-sm-4   ">
                           
                                         <input type="text" class="  form-control bg-white" id="contract_end_date" name="contract_end_date"  value="{{$qry->contract_end_date}}"  placeholder="" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
                                          
                                        </div>
         <button type="button" class="btn ml-5 btn-new mt-4 " data-toggle="modal" data-target="#ContractModal">Add detail line data to contract</button>
        ...
        <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            $distributors=DB::Table('distributors')->where('is_deleted',0) ->orderBy('distributor_name','asc')->get();
                                             ?>
                                            <div class="col-sm-5">
                                                 <select type="" class="form-control select2" id="distributor_id"  value="" name="distributor_id"   >
                                                    <option value=""  data-logo="" >     </option>
                                                    @foreach($distributors as $c)
                                  <option value="{{$c->id}}"  data-logo="{{$c->distributor_image}}"  {{$qry->distributor_id==$c->id?'selected':''}} >{{$c->distributor_name}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control"  id="reference_no" name="reference_no"   value="{{$qry->reference_no}}" placeholder=" "  > 
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                 <input type="text" class="form-control"  id="distrubutor_sales_order_no" name="distrubutor_sales_order_no"  value="{{$qry->distrubutor_sales_order_no}}"  placeholder=" "  > 
                                            </div>
          ...
          <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                            ...
                                            <div class="col-sm-4">
                                                 <input type="text" class="form-control"  id="estimate_no" name="estimate_no"   value="{{$qry->estimate_no}}"    placeholder=" "  > 
                                            </div>
                                          
                                    
                                            <label class="col-sm-2 col-form-label text-md-center" for="example-hf-email">Sales Order #</label>
                                            <div class="col-sm-4">
                                                 <input type="text" class="form-control"  id="sales_order_no" name="sales_order_no" value="{{$qry->sales_order_no}}"   placeholder=""  > 
                                            </div>
                                            ...
                                            <div class="col-sm-4 form-group ">
                                                 <input type="text" class="form-control"  id="invoice_no" value="{{$qry->invoice_no}}" name="invoice_no" placeholder=""  > 
                                            </div>
                                              <label class="col-sm-2 col-form-label text-md-center  t  " style="margin-left: -5px;"  for="example-hf-email">Invoice Date</label>
                                            <div class="col-sm-4 form-group " style="margin-left: 5px;">
                     
                     <input type="text" class="js-flatpickr form-control bg-white" id="invoice_date"   value="{{$qry->invoice_date}}"    name="invoice_date" placeholder="Y-M-d" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-sm-4 form-  ">
                                                 <input type="text" class="form-control"  id="po_no"  value="{{$qry->po_no}}"  name="po_no" placeholder=""  > 
                                            </div>
                                              <label class="col-sm-2 col-form-label  text-md-center   ht" style="margin-left: -20px;" for="example-hf-email">PO Date</label>
                                            <div class="col-sm-4 form-  " style="margin-left:20px">
                      
                         <input type="text" class="js-flatpickr form-control bg-white" id="po_date"  value="{{$qry->po_date}}" name="po_date" placeholder="Y-M-d" data-alt-input="true" data-date-format="Y-m-d" data-alt-format="Y-M-d">
                                            </div>
...
<div class="modal fade" id="ContractModal" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modal-block-large" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-bac " role="document">
                <div class="modal-content">
                    <div class="block  block-transparent mb-0">
...
<div class="col-sm-10   form-group      ">
          <select     class="form-control multiple  selectpicker" multiple="" required="" data-live-search="true" id="hostname_modal" name="hostname_modal[]"   >
              <?php $asset_qry=DB::Table('assets')->where('client_id',$qry->client_id)->where('is_deleted',0)->where('HasWarranty',1)
              ->where('AssetStatus',1)->orderBy('hostname','asc')->get(); ?>
            @foreach($asset_qry as $a)

 @if($a->asset_type=='physical')
<option value='{{$a->id}}'  data-hostname="{{$a->hostname}}" data="{{$a->sn}}">{{$a->sn}} [{{$a->hostname}}]</option>
@else
     <option value='{{$a->id}}'  data-hostname="{{$a->hostname}}" data="{{$a->sn}}">{{$a->hostname}}</option>
                    @endif
            @endforeach      
         </select>
...
<div class="modal fade" id="ContractModalEdit" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modal-block-large" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-bac " role="document">
                <div class="modal-content">
                    <div class="block  block-transparent mb-0">
                        <div class="block-header pb-0  ">
...
<div class="col-sm-10   form-group      ">
          <select     class="form-control multiple  selectpicker" multiple="" required="" data-live-search="true" id="hostname_modal_edit" name="hostname_modal_edit[]"   >
                 <?php $asset_qry=DB::Table('assets')->where('client_id',$qry->client_id)->where('is_deleted',0)->where('HasWarranty',1)->where('AssetStatus',1)->orderBy('hostname','asc')->get(); ?>
            @foreach($asset_qry as $a)
...
var msrp=$('input[name=msrp]').val();
 var hostname_modal=$('#hostname_modal').val();
     ...
     if(pn_no==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1">  Please enter a value for Pn #', delay: 5000});

    }
    else if(qty==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Qty', delay: 5000});
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select Description', delay: 5000});
           ...
           contractDetailsArray.push({key:contract_key_count,pn_no:pn_no,qty:qty,msrp:msrp,hostname_modal:hostname_modal,asset_description:asset_description,asset_array:asset_array  });
           showcontractDetails()   
                                            ...
                                            <tbody>
                                                ...
                                                <tr >
                                                    <td colspan="2"  class="pt-0" style="vertical-align: top;" >
                                                       <p class="pl-4 mb-0 comments-section-text">`;

                                                        for(var j=0;j<assets.length;j++){
                                                          html+=`<div class="contract_type_button mr-1" >
  <input type="radio"   />
  <label class="btn btn-new  py-1" style="width:fit-content">${assets[j]}</label>
</div>`;
                                                        }
...
$.ajax({
    ...
    'method':'get',
    data:{id:'<?php echo $_GET['id'] ?>'},
    url:"{{url('get-comments-contracts')}}",
    success:function(res){
        for(var i=0;i<res.length;i++){
            var date=res[i].date;
...
$.ajax({
    ...
    'method':'get',
    data:{id:'<?php echo $_GET['id'] ?>'},
    url:"{{url('get-attachment-contracts')}}",
    success:function(res){
        for(var i=0;i<res.length;i++){
            var date=res[i].date;
            var newDate=new Date(date);
...
$.ajax({
    ...
    'method':'get',
    data:{id:'<?php echo $_GET['id'] ?>'},
    url:"{{url('get-details-contracts')}}",
    success:function(res){
        for(var i=0;i<res.length;i++){
            var date=res[i].date;
            var newDate=new Date(date);
            var hostname=[];
            if(res[i].hostname!=null){
                    hostname=res[i].hostname.split(',');
            }
            var asset=[];
            if(res[i].asset!=null){
                    asset=res[i].asset.split(',');
            }
  ...
  "July", "Aug", "Sep", "Oct", "Nov", "Dec"
    ...
    var date1=newDate.getFullYear()+'-'+monthNames[newDate.getMonth()]+'-'+newDate.getDate();
    var time=newDate.toLocaleString('en-US', { hour: date1.getHours, minute:date1.getSeconds, hour12: true }) ;
 contractDetailsArray.push({key:i,pn_no:res[i].pn_no,qty:res[i].qty,msrp:res[i].msrp,hostname_modal:asset,asset_description:res[i].detail_comments,asset_array:hostname  });
            ...
            $.ajax({
               ...
               success:function(res){
                    var html='';
                          ...
                          // if(email!='' || email!='null'){
                          //   email_key_count++;
                          //   emailArray.push({key:0,email_key_count,email:renewal_notification_email})
                          // }
                    for(var i=0;i<res.length;i++){
...
$('#distributor_id').change(function(){
        ...
        if( logo!=''){
            $('#distributorInfo').html('<div class="col-sm-8">'+
                                                ...
                                                '<img class="img-avatar" style="width:90px;height:90px"   src="{{asset("public/distributor_logos/")}}/'+logo+'" alt="">'+
...
$('#vendor_id').change(function(){
        ...
        if( logo!=''){
            $('#vendorInfo').html('<div class="col-sm-8">'+
                                                ...
                                                '<img class="img-avatar" style="width:90px;height:90px"  src="{{asset("public/vendor_logos/")}}/'+logo+'" alt="">'+
...
console.log(newdate)
  $("#contract_end_date").flatpickr({defaultDate:newdate});
...
$('#type_modal').change(function(){
   ...
   var client_id= $('#client_id').val();
    $.ajax({
        type:'get',
        data:{val:val,client_id:client_id},
        ...
        success:function(res){
            ...
            for(var i=0;i<res.length;i++){
                    if(val=='physical'){
 html+='<option value='+res[i].id+'  data-hostname="'+res[i].hostname+'" data="'+res[i].sn+'">'+(res[i].sn==null?'':res[i].sn)+' ['+res[i].hostname+']</option>';
                    }
                    else{
                        html+='<option value='+res[i].id+'  data-hostname="'+res[i].hostname+'" data="'+res[i].sn+'">'+res[i].hostname+'</option>'; 
                    }
...
if(click==1){
   Dashmix.helpers('notify', {message: 'Close window?  <a href="javascript:;" class="  btn-notify btnCloseUndo ml-4" >Proceed</a>', delay: 5000});
    ...
    window.location.href=unEntity('{{URL::previous()==URL::full()?url('contract/'.$type.''):URL::previous()}}');
}
})
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for Vendor.', delay: 5000});

    }
      else  if(contract_no==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Contract No.', delay: 5000});

    }
      else  if(registered_email==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for End User Email.', delay: 5000});

    }
      else  if(contract_start_date==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for Start Date.', delay: 5000});

    }
      else  if(contract_end_date==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for End Date.', delay: 5000});

    }
        else  if (start_date.getTime() > end_date.getTime()) {
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> End Date cannot be greater than Start Date.', delay: 5000});
...
$.ajax({
    ...
    success:function(res) {
        ...
        Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Contract Saved Succesfully', delay: 5000});
    click=0;
