...
$periodFiltersApplied = $filters->period ?? [];
?>
...
<div class="block new-block position-relative  5">
    <div class="block-header py-0 d-flex justify-content-between align-items-start"
        ...
        <div>
            ...
            <p style="font-size: 11pt !important;">
                {{ date('d-M-Y', strtotime(getFiscalYearEnd($client->fiscal_start, $filters))) }}</p>
        </div>
    ...
    <div class="block-content pb-0   " style="padding-left: 32px;padding-right: 32px; padding-bottom: 20px !important;">
        ...
        @if ($rollups == 'None')
            ...
            ?>
            @foreach ($period_array as $key => $pr)
                <div class="row">

                    <div class="col-sm-12">
                        <div class="d-flex text-nowrap">
                            <div>
                                <p class=" pr-1 mb-0 ">Period: {{ $pr }}</p>
                            </div>
                            ...
                            <div class="col-md-12 " style="    padding-left: 4rem!important;">
                                <table class="table border-0 table-period">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        @foreach (DB::table('journals as j')->where('j.is_deleted', 0)->where('j.client', $filters->client_id)->where('j.fyear', $filters->fiscal_year)->where('j.period', $pr)->where(function ($query) use ($filters) {
            if (count($filters->period) > 0) {
                $query->whereIn('j.period', $filters->period);
            }
            if (count($filters->source) > 0) {
            ...
            $join->on('j.source', '=', 'sc.id')->where('sc.is_deleted', 0);
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:0;border:0 !important;">{{ $pr }}</td>
                                        ...
                                        <tr>
                                            <td colspan="6" style="font-weight:600;padding:0;border:0 !important;">
                                                <p class="mb-0 filter-applied">Applied
                                                    Filters:</p>
                                                @if (count($periodFiltersApplied) > 0)
                                                    <span class="tags">Periods:@foreach ($periods as $p)
                                                            {{ in_array($p, $periodFiltersApplied) ? $p . ',' : '' }}
                                                        @endforeach
                                                    </span>
                                                    <br>
                                                @endif
                                                @if (count($sourceFiltersApplied) > 0)
                                                    <span class="tags">Sources: @foreach ($sources as $s)
                                                            {{ in_array($s->id, $sourceFiltersApplied) ? $s->source_code . ',' : '' }}
                                                        @endforeach </span><br>
                                                @endif
                                                @if (count($accountFiltersApplied) > 0)
                                                    <span class="tags">Accounts: @foreach ($accountFiltersApplied as $account_no)
                                                            {{ $account_no . ',' }}
                                                        @endforeach </span>
                                                @endif
                                            </td>
                                            <td style="font-weight: 600;padding:0;border:0" class="text-right">
                                                Period {{ $pr }} - Sub-Total</td>
                                            <td class="text-right"
                                                style="font-weight:600;padding:0;border:0 !important;">
                                                <span
                                                    style="border-top:1px solid #595959 !important;border-bottom:1px solid #595959 !important;padding-top:2px;padding-bottom:2px;">{{ number_format($period_level_debit, 2, '.', '') }}</span>
                                            </td>
                                            <td class="text-right"
                                                style="font-weight:600;padding:0;border: 0 !important;">
                                                <span
                    ...
                    <table class="table border-0 table-totals">
                        <tfoot>
                            <tr>
                                ...
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight:600;border:0 !important;"></td>
                                <td style="font-weight: 600;border:0" class="text-right">
                                    Fiscal Year
                                ...
                                <td class="text-right" style="font-weight:600;padding:0;border:0 !important;">
                                    <span class="" style="border-bottom: 2px solid #595959;padding-bottom: 5px;">
                                        <span
                                            style="border-top:1px solid #595959 !important;border-bottom:1px solid #595959 !important;padding-top:2px;padding-bottom:2px;">{{ number_format($fiscal_year_debit, 2, '.', '') }}</span>
                                    </span>
                                </td>
                                <td class="text-right" style="font-weight:600;padding:0;border: 0 !important;">
                                    <span class="" style="border-bottom: 2px solid #595959;padding-bottom: 5px;">
        ...
        @elseif($rollups == 'Source')
            ...
            $join->on('j.source', '=', 'sc.id')->where('sc.is_deleted', 0);
                                                            ...
                                                            <tr>
                                                                <td style="padding:0;border:0 !important;float: left">
                                                                    <div
                                                                        style="text-align: right;margin-right: 15px !important">
                                                                        {{ $j->editNo }}
                                                                    </div>
                                                                </td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td class="text-right"
                                                                style="font-weight:600;padding:0;border:0 !important;">
                                                                <span
                                                                    style="border-top:1px solid #595959 !important;border-bottom:1px solid #595959 !important;padding-top:2px;padding-bottom:2px;">{{ number_format($period_level_credit, 2, '.', '') }}</span>
                                                            </td>
                                                        </tr>
                                                        @if ($period_level_debit > $period_level_credit)
                                                            @php
                                                                $difference = round(
                                                                    $period_level_debit - $period_level_credit,
                                                                    2,
                                                                );
                                                            @endphp
                                                            @if ($difference > 0)
                                                                <tr>
                                                                    ...
                                                                    <td style="font-weight: 600;padding:0;border:0"
                                                                        class="text-right"></td>
                                                                    <td class="text-right"
                                                                        style="font-weight:600;padding:0;border:0 !important;">
                                                                    </td>
                                                        ...
                                                        @elseif ($period_level_debit < $period_level_credit)
                                                            @php
                                                                $difference = round(
                                                                    $period_level_credit - $period_level_debit,
                                                                    2,
                                                                );
                                                            @endphp
                                                            @if ($difference > 0)
                        ...
                        <table class="table border-0 table-totals">
                            <tfoot>
                                <tr style="min-height: 45px;">
                                    ...
                                    <td class="text-right" style="font-weight:600;border:0 !important;">
                                        <span class="" style="border: 0;">
                                            <span
                                                style="border-top:1px solid #595959 !important;border-bottom:1px solid #595959 !important;padding-top:2px;padding-bottom:2px;">{{ number_format($source_level_debit, 2, '.', '') }}</span>
                                        </span>
                                    </td>
                                    <td class="text-right" style="font-weight:600;border: 0 !important;">
                                        <span class="" style="border: 0;">
        ...
        @elseif($rollups == 'Account')
                                                ...
                                                @if (findJournalIn($filters, $periods[$p], $account->account_no, $source->id))
                                                    <div class="row">
                                                        <div class="col-sm-12 pl-5">
                                                            <div class="d-flex text-nowrap">
                                                                <div>
                                                                    <p class=" pr-1 mb-0 ">Period: {{ $periods[$p] }}
                                                                    </p>
                                                                </div>
                                                                <hr class="w-100"
                                                                    style="border-color: #595959!important">
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12 "
            ...
            $join->on('j.source', '=', 'sc.id')->where('sc.is_deleted', 0);
                                                                                ...
                                                                                {{-- @if ($j->period == $periods[$p] && $j->account_no == $account->account_no && $j->source == $source->id) --}}
                                                                                <?php
                                                                                $fiscal_year_debit += $j->debit;
                                                                                $fiscal_year_credit += $j->credit;
                                                                                $source_level_debit += $j->debit;
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        style="padding:0;border:0 !important;float: left;">
                                                                                        <div
                                                                                            style="text-align: right;margin-right: 15px !important">
                                                                                            {{ $j->editNo }}
                                                                                        </div>
                                                                        ...
                                                                        <tfoot>
                                                                            <tr>
                                                                                <td colspan="6"
                                                                                    style="font-weight:600;padding:0;border:0 !important;">
                                                                                    <p class="mb-0 filter-applied">
                                                                                        Applied Filters:</p>
                                                                                    @if (count($periodFiltersApplied) > 0)
                                                                                        <span class="tags">Periods:
                                            ...
                                            <table class="table border-0 table-totals">
                                                <tfoot>
                                                    <tr style="min-height: 45px;">
                                                        ...
                                                        <td style="font-weight:600;border:0 !important;">
                                                        </td>
                                                        <td style="font-weight:600;border:0 !important;">
                                                        </td>
                                                        <td style="font-weight:600;border:0 !important;">
                                                        ...
                                                        <td class="text-right"
                                                            style="font-weight:600;border:0 !important;">
                                                            <span class="" style="border: 0;">
                                                                <span
                                                                    style="border-top:1px solid #595959 !important;border-bottom:1px solid #595959 !important;padding-top:2px;padding-bottom:2px;">{{ number_format($account_level_debit, 2, '.', '') }}</span>
                                                            </span>
                                                        </td>
                                                        <td class="text-right"
                                                            style="font-weight:600;border: 0 !important;">
                                                    ...
                                                    @if ($account_level_debit > $account_level_credit)
                                                        @php
                                                            $difference_ = round(
                                                                $account_level_debit - $account_level_credit,
                                                                2,
                                                            );
                                                        @endphp
                                                        @if ($difference_ > 0)
                                                    ...
                                                    @elseif ($account_level_debit < $account_level_credit)
                                                        @php
                                                            $difference_ = round(
                                                                $account_level_credit - $account_level_debit,
                                                                2,
                                                            );
                                                        @endphp
                                                        @if ($difference_ > 0)
