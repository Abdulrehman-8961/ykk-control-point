                            ...
                            <div class="row   form-group">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <select class="form-control  " name="system_salutation">
                                        ...
                                        <option value="Mr" {{ $system_settings->salutation == 'Mr' ? 'selected' : '' }}>Mr

                                        </option>

                                        <option value="Mrs" {{ $system_settings->salutation == 'Mrs' ? 'selected' : '' }}>Mrs
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select class="form-control  select2" name="system_designation">
                                        ...
                                        <option value="CIPM" {{ $system_settings->designation == 'CIPM' ? 'selected' : '' }}>

                                            CIPM</option>

                                        <option value="CFA" {{ $system_settings->designation == 'CFA' ? 'selected' : '' }}>CFA

                                        </option>

                                        <option value="CBV" {{ $system_settings->designation == 'CBV' ? 'selected' : '' }}>CBV

                                        </option>

                                        <option value="CMT" {{ $system_settings->designation == 'CMT' ? 'selected' : '' }}>CMT

                                        </option>

                                        <option value="CAIA" {{ $system_settings->designation == 'CAIA' ? 'selected' : '' }}>

                                            CAIA</option>

                                        <option value="ChMC" {{ $system_settings->designation == 'ChMC' ? 'selected' : '' }}>

                                            ChMC</option>

                                        <option value="CGMA" {{ $system_settings->designation == 'CGMA' ? 'selected' : '' }}>
                                        ...
                                        <option value="CAPA" {{ $system_settings->designation == 'CAPA' ? 'selected' : '' }}>

                                            CAPA</option>

                                        <option value="CAPP" {{ $system_settings->designation == 'CAPP' ? 'selected' : '' }}>

                                            CAPP</option>

                                        <option value="CPA" {{ $system_settings->designation == 'CPA' ? 'selected' : '' }}>CPA

                                        </option>

                                        <option value="CICS" {{ $system_settings->designation == 'CICS' ? 'selected' : '' }}>

                                            CICS</option>

                                        <option value="CICP" {{ $system_settings->designation == 'CICP' ? 'selected' : '' }}>

                                            CICP</option>

                                        <option value="CFP" {{ $system_settings->designation == 'CFP' ? 'selected' : '' }}>CFP

                                        </option>

                                        <option value="CDFA" {{ $system_settings->designation == 'CDFA' ? 'selected' : '' }}>

                                            CDFA</option>

                                        <option value="CAMS" {{ $system_settings->designation == 'CAMS' ? 'selected' : '' }}>

                                            CAMS</option>

                                        <option value="CFC" {{ $system_settings->designation == 'CFC' ? 'selected' : '' }}>CFC

                                        </option>

                                        <option value="CCUFC" {{ $system_settings->designation == 'CCUFC' ? 'selected' : '' }}>

                                            CCUFC</option>

                                        <option value="CLU" {{ $system_settings->designation == 'CLU' ? 'selected' : '' }}>CLU

                                        </option>



                                        <option value="CFE" {{ $system_settings->designation == 'CFE' ? 'selected' : '' }}>CFE

                                        </option>

                                        <option value="CIA" {{ $system_settings->designation == 'CIA' ? 'selected' : '' }}>CIA

                                        </option>



                                        <option value="CRMA" {{ $system_settings->designation == 'CRMA' ? 'selected' : '' }}>

                                            CRMA</option>

                                        <option value="CGAP" {{ $system_settings->designation == 'CGAP' ? 'selected' : '' }}>

                                            CGAP</option>

                                        <option value="CPP" {{ $system_settings->designation == 'CPP' ? 'selected' : '' }}>CPP

                                        </option>

                                        <option value="FPC" {{ $system_settings->designation == 'FPC' ? 'selected' : '' }}>FPC

                                        </option>

                                        <option value="CCMT" {{ $system_settings->designation == 'CCMT' ? 'selected' : '' }}>

                                            CCMT</option>

                                        <option value="CGFM" {{ $system_settings->designation == 'CGFM' ? 'selected' : '' }}>

                                            CGFM</option>

                                        <option value="CGFO" {{ $system_settings->designation == 'CGFO' ? 'selected' : '' }}>

                                            CGFO</option>

                                        <option value="CMA" {{ $system_settings->designation == 'CMA' ? 'selected' : '' }}>CMA

                                        </option>

                                        <option value="CMFO" {{ $system_settings->designation == 'CMFO' ? 'selected' : '' }}>

                                            CMFO</option>

                                        <option value="CPFA" {{ $system_settings->designation == 'CPFA' ? 'selected' : '' }}>

                                            CPFA</option>

                                        <option value="CPFO" {{ $system_settings->designation == 'CPFO' ? 'selected' : '' }}>

                                            CPFO</option>

                                        <option value="CPCU" {{ $system_settings->designation == 'CPCU' ? 'selected' : '' }}>

                                            CPCU</option>

                                        <option value="CDFM" {{ $system_settings->designation == 'CDFM' ? 'selected' : '' }}>

                                            CDFM</option>

                                        <option value="CMP" {{ $system_settings->designation == 'CMP' ? 'selected' : '' }}>CMP

                                        </option>

                                        <option value="RTRP" {{ $system_settings->designation == 'RTRP' ? 'selected' : '' }}>

                                            RTRP</option>

                                        <option value="EA" {{ $system_settings->designation == 'EA' ? 'selected' : '' }}>EA

                                        </option>



                                        <option value="FICF" {{ $system_settings->designation == 'FICF' ? 'selected' : '' }}>
                                        ...
                                        <option value="FIC" {{ $system_settings->designation == 'FIC' ? 'selected' : '' }}>FIC

                                        </option>

                                        <option value="FP&A" {{ $system_settings->designation == 'FP&A' ? 'selected' : '' }}>
                                        ...
                                        <option value="ISSP Sustainability"
                                            ...
                                            {{ $system_settings->designation == 'ISSP Sustainability' ? 'selected' : '' }}>ISSP

                                            Sustainability</option>

                                        <option value="CTP" {{ $system_settings->designation == 'CTP' ? 'selected' : '' }}>CTP

                                        </option>

                                        <option value="CTFA" {{ $system_settings->designation == 'CTFA' ? 'selected' : '' }}>
                                        ...
                                        <option value="RFP" {{ $system_settings->designation == 'RFP' ? 'selected' : '' }}>RFP

                                        </option>

                                        <option value="FRM" {{ $system_settings->designation == 'FRM' ? 'selected' : '' }}>FRM

                                        </option>



                                        <option value="PRM" {{ $system_settings->designation == 'PRM' ? 'selected' : '' }}>PRM

                                        </option>

                                        <option value="SCMP" {{ $system_settings->designation == 'SCMP' ? 'selected' : '' }}>

                                            SCMP</option>

                                        <option value="LPA" {{ $system_settings->designation == 'LPA' ? 'selected' : '' }}>LPA

                                        </option>

                                        <option value="ABA" {{ $system_settings->designation == 'ABA' ? 'selected' : '' }}>ABA

                                        </option>

                                        <option value="IACCP" {{ $system_settings->designation == 'IACCP' ? 'selected' : '' }}>
