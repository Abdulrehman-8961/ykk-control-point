...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/style.css') }}?c={{ rand(1, 9999) }}">
    ...
    <link rel="stylesheet" data-purpose="Layout StyleSheet" title="Web Awesome"
        href="/css/app-wa-180076bd62c3b29f3534c3057e9601a2.css?vsn=d">
    ...
    <style type="text/css">
        ...
        .select2-container--default .select2-selection--clearable:hover,
        .bootstrap-select .btn:hover {
            border: 1px solid !important;
            border-color: #2485E8 !important;
            /* box-shadow: 0 0 1px 1px rgba(36, 133, 232, 0.6) !important; */
        }
