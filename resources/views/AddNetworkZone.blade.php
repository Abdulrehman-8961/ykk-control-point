                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">New Network Zone</h4>
   ...
   <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group ">
                                            ...
                                            <div class="col-sm-4">
                                                      <input type="text" class="form-control"  id="network_zone_description"   name="network_zone_description" placeholder=""  > 
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                  <input type="color" class="form-control"  id="tag_back_color"   name="tag_back_color" placeholder=""  > 
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                  <input type="color" class="form-control"  id="tag_text_color"  name="tag_text_color" placeholder=""  > 
                                            </div>
                                                    
                                                          <div class="col-sm-2">
                                                 <div style="box-shadow:none;padding-bottom: 0px;padding-top:0px;min-height:29px;width:!important;border-radius:5px;background:black;color: #ffffff" class=" text-center px-2 border-none  font-size-md badgeAuto  bubble-white-new bubble-text-sec"></div>
                                                 <div>
...
if(data1==0){
        ...
        Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Network Zone Succesfully added', delay: 5000});

       
     window.location.href=unEntity('{{URL::previous()==URL::full()?url('network-zone'):URL::previous()}}');
}else{
