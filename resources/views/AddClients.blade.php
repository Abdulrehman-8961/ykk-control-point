...
.avatar-upload .avatar-preview > div {
  ...
  background-position: center;
                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-blue new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text" style="line-height:25px">New Client</h4>
                                <p class="mb-0  header-new-subtext" style="line-height:15px"><?php echo date('Y-M-d').' at '.date('H:i:s').' GMT'  ?> by {{Auth::user()->firstname.' '.Auth::user()->lastname}}</p>
                                    ...
                                    <div class="new-header-icon-div">
                                           ...
                                           <a href="javascript:;"  class="saveContract text-white"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Add and Continue"  class="text-white"><i class="fa fa-plus texti-white"  ></i> </a>
                                              ...
                                              <a href="javascript:;" class="text-white saveContract" data="0" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save User"><i class="fa fa-check text-white"   ></i> </a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-client_id">Primary Contact</label>
                                            <?php
   ...
   <div class="col-sm-4 form-group">
                                            ...
                                            <div class="col-sm-4  ">
                                                 ...
                                                 <div class="col-lg-8">            
                                  <div class="form-group row">
                                            <label class="col-sm-3  col-form-label mandatory" for="example-hf-client_id">Company Name</label>
        ...
        <div class="avatar-preview">
            <div id="imagePreview" style="background-image: url('{{asset('public/img')}}/image-default.png');">
            </div>
        </div>
    </div>
</div>
                                 ...
                                 <div class="col-lg-12">
                                   <div class="form-group row">
                                                         <label class="col-sm-2 mandatory col-form-label" for="email">Email Address </label>
                                     ...
                                     <div class="form-group row">
                                          ...
                                          <label class="col-sm-2 text-center   col-form-label" for="example-hf-email">Fax </label>
                                            <div class="col-sm-3">
    ...
    <div class="block new-block   " >
                            ...
                            <div class="block-content new-block-content">
                                      ...
                                      <div class="row form-group ">
                                            ...
                                            <div class="col-sm-6">
                                                  <select   type="text" class="form-control select2"    id="country" name="country" placeholder=""  > 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                             ...
                                             <div class="form-group row">
                                            <label class="col-sm-2 mandatory col-form-label" for="example-hf-email">State/Province</label>
                                            <div class="col-sm-6">
                                              <input  class="form-control" id="state" name="state"   > 
                                        </div>
                                       </div>
                                         <div class="form-group row">
                                            <label class="col-sm-2 mandatory col-form-label" for="example-hf-email">Zip/Postal Code</label>
                                            <div class="col-sm-6">
   ...
   <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="contract_notification" name="contract_notification" value="1" checked="">
  ...
  <div id="ContractEmailBlock" class="ContractEmailHide">  
                                                     
                               
                                                   </div>

                                                    <button type="button" data-toggle="modal" data-target="#ContractEmailModal" class="btn ContractEmailHide ml-5 mt-3 btn-new ">Add Email Address</button>
</div>
</div>
   ...
   <div class="block new-block" >
                            ...
                            <div class="block-content new-block-content">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="custom-control custom-switch custom-control-warning custom-control-lg mt-2 ">
                                                <input type="checkbox" class="custom-control-input" id="cert_notification" name="cert_notification" value="1" checked="">
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for firstname.', delay: 5000});

    }
     else if(lastname==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for lastname.', delay: 5000});

    }


      else  if(company_name=='' ){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for company name.', delay: 5000});

    }
 else  if( firstname==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for display name.', delay: 5000});

    } else  if(email==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for email.', delay: 5000});

    }

    else  if(country==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for country.', delay: 5000});

    }
     else  if(client_address==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for address.', delay: 5000});

    }

      else  if(city==''){
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please select a value for city.', delay: 5000});
...
Dashmix.helpers('notify', {message: '<img src="{{asset('public/img/warning-yellow.png')}}" width="30px" class="mt-n1"> Please enter a value for zip.', delay: 5000});
...
for(var i=0;i<ContractemailArray.length;i++){
    formData.append('notification_renewal_email[]',JSON.stringify(ContractemailArray[i]));
}
...
if(data1==0){
        ...
        Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Client Succesfully added', delay: 5000});

       
     window.location.href=unEntity('{{URL::previous()==URL::full()?url('clients'):URL::previous()}}');
}else{
      Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Client Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding client</span>', delay: 5000});
}
