...
if(Auth::user()->role=='read'){
 ...
 $qry=DB::Table('sites')->where('id',$_GET['id'])->first();
?>
                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-dark new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text " style="line-height:27px">Edit Sites</h4>
  ...
  <div class="block-header py-0" style="padding-left:7mm;">
                           ...
                           <div class="row">
                                  ...
                                  <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                               <input type="text" class="form-control valid" id="site_name" name="site_name" placeholder="Site Name"   aria-invalid="false" value="{{$qry->site_name}}">
                                            </div>
 ...
 <?php
                                            ...
                                            $countries=DB::Table('countries')->orderBy('name','asc') ->get();
                                             ?>
                                                    ...
                                                    <option value="{{$c->name}}" {{$qry->country==$c->name?'selected':''}}>{{$c->name}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                        </div>
                                      ...
                                      <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                 <textarea type="text" class="form-control" id="address" name="address" placeholder="Enter Address"  >{{$qry->address}}</textarea>
                                            </div>
                                        ...
                                        <div class="  row">
                                            <label class="col-sm-2 col-form-label mandatory" for="example-hf-email">City </label>
                                               ...
                                               <div class="col-sm-4 form-group">
                                                 <input type="text" class="form-control"  list="cityDatalist"   id="city" name="city" placeholder="City"   value="{{$qry->city}}">
                                            ...
                                            <div class="col-sm-4 form-group">
                                                   <input type="text" class="form-control" list="modelDatalist" id="province"    name="province" placeholder="Province"  value="{{$qry->province}}" >
                                      ...
                                      <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                       <input type="text" class="form-control" id="zip" name="zip"  placeholder="Zip"  value="{{$qry->zip_code}}" >
                                            </div>
                                         ...
                                         <div class="f  row">
                                            ...
                                            <div class="col-sm-2 form-group">
                                                 <input type="" class="form-control" id="phone" name="phone" placeholder="Phone" value="{{$qry->phone}}" >
                                            </div>
                                            <div class="col-sm-2 form-group">
                                                 <input type="" class="form-control" id="fax" name="fax" placeholder="Fax" value="{{$qry->fax}}" >
                                            </div>
...
$('#site_name').val('');
  ...
  //  window.location.href=unEntity('{{URL::previous()==URL::current()?url('sites'):URL::previous()}}');
