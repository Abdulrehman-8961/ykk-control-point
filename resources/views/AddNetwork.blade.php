...
.btnDeleteAttachment{
                ...
                <!-- Hero -->
                            ...
                            <div class="block card-round   bg-new-dark new-nav" >
                               ...
                               <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                ...
                                <div class="ml-4">
                                <h4  class="mb-0 header-new-text " style="line-height:27px">New Network</h4>
                                <p class="mb-0  header-new-subtext" style="line-height:17px"><?php echo date('Y-M-d') ?> by {{Auth::user()->firstname.' '.Auth::user()->lastname}}</p>
                                    ...
                                    <div class="new-header-icon-div">
                                           ...
                                           <a href="javascript:;"  class="saveContract text-white" data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Add and Continue"  class="text-white"><i class="fa fa-plus texti-white"  ></i> </a>
                                              ...
                                              <a href="javascript:;" class="text-white saveContract"  data="0"  data-toggle="tooltip" data-trigger="hover" data-placement="top" title="" data-original-title="Save Network"><i class="fa fa-check text-white"   ></i> </a>
 ...
 <?php
                                            ...
                                            <div class="col-sm-4">
                                                <select type="" class="form-control select2" id="network_zone"  value="" name="network_zone"   >
                                                    ...
                                                    <option value="{{$c->network_zone_description}}" {{old('network_zone_description')==$c->network_zone_description?'selected':''}}>{{$c->network_zone_description}}</option>
                                                    @endforeach
                                                    </select>
                                            </div>
                                        </div>
 ...
 <div class="col-sm-2">
                                                <div class="contract_type_button  w-100 mr-4 mb-3">
  <input type="checkbox" class="custom-control-input" id="wifi_enabled" name="wifi_enabled" value="1">
  <label class="btn btn-new w-75 WifiDiv " for="wifi_enabled">No</label>
</div>
                                            </div>
                                        </div>
   ...
   <div class="block new-block d-none WifiHide" >
             ...
             <label class="col-sm-2    col-form-label" for="example-hf-email">SSID Name  </label>
              ...
              <div class="col-sm-4">
                               <input type="text" class="form-control"  id="ssid_name" name="ssid_name"   > 
                          </div>
                                                </div>
                                                 <div class="row form-group ">
             ...
             <label class="col-sm-2    col-form-label" for="example-hf-email">Encryption  </label>
              ...
              <div class="col-sm-4">
                                ...
                                <option value="PSK with RADIUS">PSK with RADIUS</option>
                                     <option value="PSK (WPA2)">PSK (WPA2)</option>
                               </select>
                          </div>
                                                </div>
...
<div class="row form-group ">
             ...
             <label class="col-sm-2    col-form-label" for="example-hf-email">Sign On Method  </label>
              ...
              <div class="col-sm-4">
                               <select type="text" class="form-control"  id="sign_in_method" name="sign_in_method"   > 
                                ...
                                <option value="MAC Address Filtering">MAC Address Filtering</option>
 ...
 <div class="col-sm-2">
  ...
  <label class="btn btn-new w-75 CertDiv " for="certificate">No</label>
</div>
                                            </div>
                                        </div>
...
<div class="row form-group ">
                                    <label class="col-sm-2  mandatory col-form-label" for="example-hf-email">Subnet IP / Mask
                                            ...
                                            <div class="col-sm-3">
                                                 <input type="text" class="form-control" id="subnet_ip" name="subnet_ip"> 
                                            </div>
                                             <div class="col-sm-1">
...
$('#certificate').val('');
  ...
  $('#hostname').focus();
        ...
        click=0;
if(data1==0){
            Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Network Succesfully added', delay: 5000});
    window.location.href=unEntity('{{URL::previous()==URL::current()?url('network'):URL::previous()}}');
}
else{
   
     Dashmix.helpers('notify', {align:'center',message: '<img src="{{asset('public/img/green-check.png')}}" width="30px" class="mt-n1"> Network Succesfully added.<br><span  style="margin-left:32px;color:lightgrey">Continue adding network</span>', delay: 5000});
